...
var VER='3.3.2',DEBUG=false,LOCALE='en-US';
...
!function(e,o,t,a,n){"use strict";e.fn.lightbox=function(n,i){if(typeof n===UNDEF)return this;i=e.extend({},e.fn.lightbox.defaults,i);var s,l,r,d,u,c,h,p,m,f,g,v,C,b,w,T,y=e(this),x=getTranslations(e.fn.lightbox.text),P=e([]),I=e(),A=e(),O=e(),S=e(),k=e(),M=e(),E=e(),D=e(),F=e(),N=e(),R=!0,L=!1,z=!1,U=!1,V=!1,B=!1,G=!1,H=!1,q=!1,Z=null,W=!1,X=null,Y=null,j=null,K=null,Q=!1,_=i.fitImages,$=-1,ee=0,oe=0,te=i.fitPadding,ae=y.data("llb_ns"),ne=!!i.hasOwnProperty("extraSizes")&&i.extraSizes.split(/,\s*/),ie=e("[data-audioplayer]"),se=ie.length&&!ie.data("paused"),le=function(){i.useZoom&&i.zoomSlider?(_=!0,he(l=l>50?0:100)):_=!_,me(!0)},re=function(e){l=e,he(e),me(!0)},de=function(e){var o=i.zoomSlider?ce():l;o<100&&(o=Math.min(100,o+(typeof e!==UNDEF?e:25))),re(o)},ue=function(e){var o=i.zoomSlider?ce():l;o>0&&(o=Math.max(0,o-(typeof e!==UNDEF?e:25))),re(o)},ce=function(){return parseInt(C.val())},he=function(e){C.val(e)},pe=function(e,o){i.zoomSlider?e||o?(u.addClass("show-zoom-level"),0===l?f.removeClass("icon-zoom-out icon-zoom-level").addClass("icon-zoom-in"):100===l?f.removeClass("icon-zoom-in icon-zoom-level").addClass("icon-zoom-out"):f.removeClass("icon-zoom-in icon-zoom-out").addClass("icon-zoom-level")):u.removeClass("show-zoom-level"):(u.toggleClass("show-zoom-out",o),u.toggleClass("show-zoom-in",e&&!o))},me=function(e,o){if(A&&A.length){var t,a,s=P.eq($).data(J.OBJ),r=[u.width(),u.height()],c=n.getDimensions(s),h=n.getMaxDimensions(s);if(typeof d===UNDEF&&(d=parseInt(A.css("paddingTop"))),typeof te===UNDEF&&(te=i.hasOwnProperty("fitRatio")?Math.round((1-i.fitRatio)*Math.min(r[0],r[1])/2):0),t=i.fitBetween?ze()?0:Math.ceil(D.outerHeight()):0,a=i.fitBetween&&u.hasClass(i.captionVisibleClass)&&M&&M.length?M.outerHeight():0,typeof l!==UNDEF&&null!==l||(l=_?0:100,i.useZoom&&i.zoomSlider&&he(l)),B||G||V||z&&S.hasClass("default")){var p=r[0]-2*te,m=r[1]-Math.max(t,te)-Math.max(a,te),f=te,g=Math.max(t,te);(V||z)&&c[0]<p&&c[1]<m&&(f+=Math.round((p-c[0])/2),g+=Math.round((m-c[1])/2),p=c[0],m=c[1]),A.css({transition:"none",left:f,top:g,width:p,height:m}).show(),i.useZoom&&pe(!1,!1)}else{var v,C,b,w,T,y=H?function(e){return Math.max((r[0]-2*te-2*d)/e[0],(r[1]-Math.max(t,te)-Math.max(a,te)-2*d)/e[1])}(c):function(e){return Math.min((r[0]-2*te-2*d)/e[0],(r[1]-Math.max(t,te)-Math.max(a,te)-2*d)/e[1])}(c),x=h[0]>c[0]?Math.min(h[0]/c[0],h[1]/c[1]):1,I=[0,0];if(v=Math.min(1,y),C=Math.max(Math.min(i.maxZoom,y),x),v>C){var O=v;v=C,C=O}if(i.useZoom?i.zoomSlider?A.data("inited")?b=v+l*(C-v)/100:(i.fitImages?(b=Math.minMax(v,y,C),l=100*Math.minMax(0,(b-v)/(C-v),1),he(l)):b=v+l*(C-v)/100,A.data("inited",!0)):A.data("inited")?b=_?Math.max(y,C):Math.min(v,y):(y<1?(_=!1,b=y):b=_?Math.min(y,C):v,A.data("inited",!0)):b=Math.minMax(v,i.fitImages?y:1,C),w=[c[0]*b,c[1]*b],T=H&&(w[0]>r[0]||w[1]>r[1])||i.autoPano&&(c[0]/c[1]>2||c[0]/c[1]<.5625)&&(w[0]/r[0]>=i.panoramaAutoDetect||w[1]/r[1]>=i.panoramaAutoDetect),R&&(h[0]>c[0]||h[1]>c[1])&&(w[0]>c[0]||w[1]>c[1])&&(!A.data("lastDims")||A.data("lastDims")[0]<w[0])&&(A.children("img").eq(0).attr("src",n.getOptimalImagePath(s,w,!0)),A.data("lastDims",w)),w=[w[0]+2*d,w[1]+2*d],e&&(typeof o===FUNCTION&&A.on("transitionEnd",function(){o.call(null)}),!i.zoomSlider||l>0)){var k,E;((k=A.translate())[0]||k[1])&&(w[0]>r[0]&&(I[0]=k[0]*w[0]/A.width(),(E=I[0]+(r[0]-w[0])/2)>.25*r[0]?I[0]=w[0]/2-r[0]/4:E+w[0]<.75*r[0]&&(I[0]=r[0]/4+1.5*w[0]),I[0]=Math.round(I[0])),w[1]>r[1]&&(I[1]=k[1]*w[1]/A.height(),(E=I[1]+(r[1]-w[1])/2)>.25*r[1]?I[1]=w[1]/2-r[1]/4:E+w[1]<.75*r[1]&&(I[1]=r[1]/4+1.5*w[1]),I[1]=Math.round(I[1])))}R&&(T?K=setTimeout(function(){A.autopano({direction:oe})},550):(clearTimeout(K),K=null,A.trigger("autopanoRemove"))),A.css({transition:e?"transform "+i.transitionProps+", left "+i.transitionProps+", top "+i.transitionProps+", width "+i.transitionProps+", height "+i.transitionProps:"none",transform:"translate("+I[0]+"px,"+I[1]+"px)",left:Math.round((r[0]-w[0])/2),top:Math.round(Math.max(te,t)+(r[1]-Math.max(t,te)-Math.max(a,te)-w[1])/2),width:Math.round(w[0]),height:Math.round(w[1])}),i.useZoom&&pe(b<C,b>v)}e||typeof o!==FUNCTION||o.call(null)}},fe=function(){var e=u.find("."+i.regionsClass);return e.length&&(i.regionsVisible=!i.regionsVisible,e.is(":visible")?e.fadeOut():e.fadeIn()),!1},ge=function(){A.css({display:A.hasClass("iframe")?"flex":"block",transition:"none",opacity:0,transform:"translateX("+100*oe+"px)"}),window.requestAnimationFrame(function(){O.data("swiped")||O.data("panomove")||O.one("transitionend",function(){O.remove(),O=e()}).css({transition:"transform "+i.speed/2+"ms ease-out, opacity "+i.speed/2+"ms ease-out",transform:"translateX("+-100*oe+"px)",opacity:0}),A.one("transitionend",function(){window.requestAnimationFrame(ve)}).css({transition:"transform "+i.speed+"ms ease-out, opacity "+i.speed+"ms ease-out",transform:"translateX(0)",opacity:1})})},ve=function(){!1!==i.onLoadEnd&&i.onLoadEnd(I),i.preloadNext&&function(){var e;oe<0&&$>0?e=P.eq($-1).data(J.OBJ):$<P.length-2&&(e=P.eq($+1).data(J.OBJ)),e&&"image"===e[J.CATEGORY]&&((new Image).src=n.getOptimalImagePath(e))}()},Ce=function(){if(!(--ee>0)){if(h.hide(),DEBUG){var o=new Date;V||B?console.log((V?"External content":"360 player")+" loaded: "+(o-r)+"ms"):S.length&&(console.log((L||z?"Media":"Image")+" ["+$+"] loaded: "+(o-r)+'ms src="'+S[0].src+'"'),typeof S[0]!==UNDEF&&typeof k[0]!==UNDEF||console.log((S[0],UNDEF,"loadImage.done("+S[0].src+")")))}(R||L||z)&&i.rightClickProtect&&k.on("contextmenu",function(e){return e.preventDefault(),!1}),(L||z)&&(k.attr({autoplay:i.videoAuto,loop:i.videoLoop}),k[0].volume=i.volume,k.on("volumechange."+ae,function(){i.volume=this.volume})),E.length&&(E.find(".buttons a").trigger("removeTooltip"),E.length>1&&(E.eq(-1).prevAll("."+i.lightboxCaptionClass).remove(),E=u.find("."+i.lightboxCaptionClass)),u.hasClass(i.captionVisibleClass)?E.one("transitionend",function(){E.remove(),E=e()}).css({transition:"opacity "+i.speed/2+"ms ease-out",opacity:0}):E.remove()),B||G||V&&A.children("iframe").length||A.swipe({onSwipeStart:function(){e(this).trigger("autopanoStop"),e(this).hideAllTooltips()},onSwipedLeft:function(){A.data("swiped",!0),He()},onSwipedRight:function(){A.data("swiped",!0),Ge()},onFinished:function(){q||(e(this).trigger("removeSwipe"),e(this).remove())},onClick:function(o){u.data("panomove")?e(this).trigger("autopanoStop"):function(o){var t="touch"===e("html").data("whatinput")||"touchend"===o.type;if(L||z){var a=k[0];return a.paused?(a.play(),"ms"!==VEND&&(a.controls=!1),t&&(Je(),u.hasClass(i.captionVisibleClass)&&Ve())):(a.pause(),"ms"!==VEND&&(a.controls=!0),t&&"togglecontrols"===i.clickAction&&(Ne(),u.hasClass(i.captionVisibleClass)||Ue())),!1}R&&("nextimage"===i.clickAction?(o.pageX||o.originalEvent.pageX)-A.position().left>A.width()/2?He():Ge():"togglecontrols"===i.clickAction?Le():"toggleall"===i.clickAction&&Be())}(o)},onRightClick:function(e){Pe(!0)},onDoubleClick:i.useZoom&&i.doubleClickZoom?function(){i.zoomSlider?l<100?de(50):re(0):le()}:null}),me(!1),L&&i.videoAuto&&k[0].paused&&playVideo(k[0]),window.requestAnimationFrame(ge),Z?(z||L)&&i.videoAuto?(Ie(),k[0].onended=function(){xe()}):(clearTimeout(Z),Z=setTimeout(He,i.slideshowDelay),w&&w.find(".progress").show()):i.autohideControls&&Re()}},be=function(e){(e=e||A).one("transitionend",function(){e.data("swiped",!1)}).css({transition:"opacity "+2*i.speed+"ms ease-out, transform "+2*i.speed+"ms ease-out",opacity:1,transform:"translateX(0)"})},we=function(o){if("number"!=typeof o&&(o=P.index(o)),o<0||o>=P.length){if(q=!0,o<0)switch(i.afterLast){case"donothing":o=0;break;case"startover":o=P.length-1;break;case"onelevelup":i.level&&(window.location.href="../"+i.indexName),o=0;break;case"nextfolder":i.baseSet&&i.previousFoldersLast&&(window.location.href=i.previousFoldersLast),o=0;break;case"nextindex":i.baseSet&&i.previousFolderPath&&(window.location.href=i.previousFolderPath),o=0;break;default:o=0,Te()}else switch(i.afterLast){case"donothing":o=P.length-1,Pe();break;case"startover":o=0;break;case"onelevelup":i.level&&(window.location.href="../"+i.indexName),o=P.length-1,Pe();break;case"nextfolder":i.baseSet&&i.nextFoldersFirst&&(window.location.href=i.nextFoldersFirst+(Z?"&slideshow":"")),o=P.length-1,Pe();break;case"nextindex":i.baseSet&&i.nextFolderPath&&(window.location.href=i.nextFolderPath),o=P.length-1;break;case"ask":var t=Pe(),l=new Array;return A.data("swiped")&&be(),o=P.length-1,P.length>1&&l.push({t:x.startOver,c:"icon-loop",h:function(e){we(0)}}),i.level&&l.push({t:i.level?x.upOneLevel:i.homepageLinkText||x.backToHome,c:"icon-one-level-up",h:function(){window.location.href="../"+i.indexName}}),l.push({t:x.backToIndex,c:"icon-thumbnails",h:function(){Te()}}),i.baseSet&&(i.nextFoldersFirst&&l.push({t:x.nextFolder,c:"icon-arrow-right",h:function(){window.location.href=i.nextFoldersFirst+(t?"&slideshow":"")}}),i.nextFolderPath&&l.push({t:x.nextIndex,c:"icon-thumbnails",h:function(){window.location.href=i.nextFolderPath}})),void u.modal(e("<p>",{class:"text-center",text:x.atLastPageQuestion}),l,{onClose:function(){we(P.length-1)},class:"secondary",title:x.atLastPage});default:o=Z?0:P.length-1,Pe(),Te()}A.data("swiped")&&be()}else q=!1;if(u.is(":visible")){if(oe=Math.abs(o-$)>=P.length-1&&"startover"===i.afterLast?1:$>o?-1:$<o?1:0,$===o)return;D.hideAllTooltips(),i.autoHideControls&&Re()}else Q=!0,a.add(e("html")).css("overflow","hidden"),a.addClass(i.lightboxOnClass),oe=0,i.lightboxFullscreen&&requestFullscreen(function(){u.addClass("fullscreen")}),i.useRating&&function(e){$>=0&&(typeof e===UNDEF&&(e=P.eq($).data(J.OBJ)[J.VISITORRATING]||0),u.find("."+i.lightboxCaptionClass+" .ratingbox span").removeClass("r0 r1 r2 r3 r4 r5").addClass("r"+e))}(),u.show(),se=ie.length&&!ie.data("paused"),i.autoStart&&ye();u.find(".modal").trigger("destroy");var d;$=o,I=P.eq($),(d=I.data(J.OBJ))?(h.show(),w&&w.find(".progress").hide(),function(e){if(L=z=U=R=B=G=!1,V=e.hasOwnProperty(J.EXTERNAL),B=!V&&i.use360Player&&e.hasOwnProperty(J.PROJECTIONTYPE)&&"equirectangular"===e[J.PROJECTIONTYPE],H=e.hasOwnProperty(J.PANORAMA)&&e[J.PANORAMA]||i.autoPano&&(e[J.IMAGE][J.WIDTH]>u.width()||e[J.IMAGE][J.HEIGHT]>u.height())&&(e[J.IMAGE][J.WIDTH]/e[J.IMAGE][J.HEIGHT]>2.4||e[J.IMAGE][J.HEIGHT]/e[J.IMAGE][J.WIDTH]>2),!V&&!B)switch(e[J.CATEGORY]){case"video":L=!0;break;case"audio":z=!0;break;case"other":U=!0,G="pdf"===n.getExtension(e).toLowerCase();break;default:R=!0}}(d),setTimeout(function(){if(O=u.find("."+i.lightboxMainClass),E=u.find("."+i.lightboxCaptionClass),O.length&&(O.trigger("autopanoRemove").off("."+ae).removeClass(i.currClass),i.muteBackgroundAudio&&se&&(z||L?ie.trigger("fadeOutPlayer"):ie.trigger("fadeInPlayer")),Fe(O)),ee=1,r=new Date,A=e("<div>",{class:"lightbox-main "+i.currClass+" "+(V?"external":B?"vr":G?"pdf":d[J.CATEGORY])}).hide().appendTo(u),R)k=S=e("<img>").appendTo(A),DEBUG&&console.log("Loading image ["+$+'] src="'+n.getOptimalImagePath(d)+'"'),S[0].complete&&S[0].naturalWidth>0?Ce():S.one("load."+ae,function(e){Ce()}),S[0].src=n.getOptimalImagePath(d);else if(z||L){if(L){var o=n.getVideoDuration(d);k=S=e("<video>",{preload:"auto",controlsList:"nodownload",poster:n.getPosterPath(d)}),o>=2e3?k[0].controls="true":k[0].loop="true"}else{var t=n.getPosterPath(d);ee=2,S=e("<img>",{class:"poster"+(t.endsWith("poster.png")?" default":"")}).one("load",function(e){Ce()}).attr("src",t).appendTo(A),k=e("<audio>",{preload:"auto",controls:"true",controlsList:"nofullscreen nodownload"})}k.one("loadedmetadata",function(e){Ce()}).attr("src",n.getSourcePath(d)).appendTo(A),k.on({playing:Me,pause:Ee,ended:De}),i.muteBackgroundAudio&&ie.length&&(se=!ie.data("paused"))}else if(V){var a=d[J.EXTERNAL].cont,l=d[J.EXTERNAL].size;l&&(l=l.split("x"),A.data({oWidth:parseInt(l[0]),oHeight:parseInt(l[1])})),A.one("DOMReady",function(e){Ce()}),a.match(/^https?\:\/\//i)||a.match(/\.html?$/i)||a.match(/^\.\.\//)?A.addClass("iframe").append(e("<iframe>",{width:"100%",height:"100%",src:a,frameborder:0,allowfullscreen:"allowfullscreen"})):(a.match(/^<iframe/i)&&A.addClass("iframe"),A.append(a)),setTimeout(Ce,200)}else if(B){var c=Math.round(u.width()*i.fitRatio),h=Math.round(u.height()*i.fitRatio);A.css({width:c,height:h}).attr("id","vr"+$).addClass("vr").show().one("DOMReady",Ce),typeof PhotoSphereViewer!==UNDEF?setTimeout(function(){var e={panorama:n.getAbsoluteImagePath(d),container:A[0],navbar:["autorotate","zoom","fullscreen"]};i.autoPano&&(e.autorotateDelay=1e3,e.autorotateSpeed="-2rpm"),new PhotoSphereViewer.Viewer(e)},i.speed):console.log('Fatal Error: Missing "photo-sphere-viewer.min.js"!'),setTimeout(Ce,200)}else{var p=A;G&&(p=!HASPDFVIEWER||ISIOSDEVICE?e("<iframe>",{src:"https://docs.google.com/viewer?url="+window.location.href.getDir()+n.getSourcePath(d)+"&embedded=true"}).appendTo(A):e("<object>",{type:"application/pdf"}).attr("data",n.getSourcePath(d)).appendTo(A)),e("<a>",{href:n.getSourcePath(d),target:"_blank"}).append(e("<img>",{class:"other"}).one("load",function(e){Ce()}).attr("src",n.getImagePath(d))).appendTo(p),e("<p>",{class:"click-hint",html:x.clickToOpen}).appendTo(p)}!function(o){M=e("<div>",{class:i.lightboxCaptionClass+(Z?" slideshow":"")});var t=e("<div>",{class:"buttons"});if(i.useRating){var a=o[J.RATING]||0;if(i.visitorRating||a){var l;(s=e("<div>",{class:"ratingbox"}).appendTo(t)).append(e("<label>",{html:x.rating})),l=e("<span>",{class:"rating",html:STARS}).appendTo(s),i.visitorRating?(o.hasOwnProperty(J.VISITORRATING)?a=o[J.VISITORRATING]:(i.useJalbumRating||(a=0),o[J.VISITORRATING]=a),l.addClass("r"+a+(i.useJalbumRating?"":" icon-close")).on("click."+ae,function(t){var a=e(this),n=Math.minMax(0,Math.floor((getCoords(t).x-a.offset().left-parseFloat(a.css("paddingLeft")))/16),5);return a.removeClass("r0 r1 r2 r3 r4 r5").addClass("r"+n),o[J.VISITORRATING]=n,y.trigger("refreshRating",P[$]),!1})):l.addClass("r"+a)}}if(!V&&ne&&"image"===o[J.CATEGORY]){s=e("<div>",{class:"download icon-download"}).appendTo(t);for(var r=n.getImagePath(o),d=0;d<ne.length;d++)s.append(e("<a>",{text:ne[d],href:r.replace("slides/","dl/"+ne[d]+"/"),download:""}))}if(i.printImage&&"image"===o[J.CATEGORY]&&!i.rightClickProtect?D.find(".print-btn").removeClass("hidden").off("."+ae).on("click."+ae,function(e){printImage(o[J.ORIGINAL]&&!i.hideDownload?o[J.ORIGINAL][J.PATH]:o[J.IMAGE][J.PATH],o[J.TITLE]||"",o[J.THUMBCAPTION]||"")}):D.find(".print-btn").addClass("hidden"),i.showDownload){var c;(R||G||i.allowDownloadOthers)&&((c=n.getOriginalPath(o))||i.allowDownloadScaled&&(c=n.getImagePath(o)))?D.find(".download-btn").removeClass("hidden").attr("href",c):D.find(".download-btn").addClass("hidden").removeAttr("href")}LOCAL&&!DEBUG||!i.hasOwnProperty("fotomoto")||n.hideFotomoto(o)||D.find(".fotomoto-btn").off("."+ae).on("click."+ae,function(e){typeof FOTOMOTO!==UNDEF&&FOTOMOTO.API.showWindow(10,n.getOriginalPath(o)||n.getItemPath(o))}),o[J.PHOTODATA]?(D.find(".photodata-btn").removeClass("hidden"),F.find(".photodata").html(o[J.PHOTODATA])):(D.find(".photodata-btn").addClass("hidden"),F.find(".photodata").empty()),i.showRegions&&(o[J.REGIONS]?(D.find(".regions-btn").removeClass("hidden").off("."+ae).on("click."+ae,fe),function(o,t){for(var a,n=e("<div>",{class:i.regionsClass}).appendTo(A),s=0;s<o.length;s++)a=o[s].split(";"),n.append(e("<div>").css({left:100*parseFloat(a[1])+"%",top:100*parseFloat(a[2])+"%",width:100*parseFloat(a[3])+"%",height:100*parseFloat(a[4])+"%"}).append("<span>"+a[0]+"</span>"));n.toggle(typeof t!==UNDEF&&t)}(JSON.parse(o[J.REGIONS]),i.regionsVisible)):D.find(".regions-btn").addClass("hidden"));var h=D.find(".audioclip-btn");!z&&o[J.AUDIOCLIP]&&h.length?(h.removeClass("hidden").off("."+ae).on("click."+ae,function(){return h.hasClass("icon-pause")?Se():Oe(),!0}),(s=F.find(".audioclip-cont")).length&&(s.empty().addClass("paused"),N=e("<audio>",{class:"audioclip",src:n.getAudioClipPath(o),controls:"",controlsList:"nofullscreen nodownload noremote noplaybackrate"}).appendTo(s),o[J.AUDIOCLIP].hasOwnProperty(J.TYPE)&&(N[0].type=o[J.AUDIOCLIP][J.TYPE],o[J.AUDIOCLIP].hasOwnProperty(J.DURATION)&&N.data("duration",o[J.AUDIOCLIP][J.DURATION])),N.on("volumechange",function(e){typeof this.volume!==UNDEF&&(i.volume=this.volume,savePrefs(i,i.prefsKept,"lb_pref"),typeof i.onVolumeChange===FUNCTION&&i.onVolumeChange(i.volume))}),N[0].volume=i.volume,i.autoplayAudioClips&&Oe())):(h.addClass("hidden").off("."+ae),F.find(".audioclip-cont").empty(),N=e()),o[J.IMAGECAPTION]&&(M.append(e("<div>",{class:"caption scrollable",html:o[J.IMAGECAPTION]})),M.find("[data-tooltip]").addTooltip()),t.is(":empty")||(M.addClass(i.hasbuttonsClass),M.append(t),t.children("a").not("[download]").addTooltip()),M.is(":empty")?(M.remove(),u.addClass("no-caption")):(M.find("[data-tooltip]").addTooltip(),u.removeClass("no-caption"),u.append(M))}(d),!1!==i.onLoadStart&&i.onLoadStart(I)},20)):console.log("Fatal error: image ("+$+") is missing from the database! (Upload data1.json again!)")},Te=function(){if(Pe(!0),y.destroyAllTooltips(),Q=!1,a.add(e("html")).css("overflow",""),a.removeClass(i.lightboxOnClass),N.remove(),i.muteBackgroundAudio&&se&&ie.trigger("fadeInPlayer"),A.length){if((z||L)&&k){var o=k[0].volume,t=i.speed/(50*o),n=function(){if(k){var e=Math.max(k[0].volume-.02,0);e>.005?(k[0].volume=e,setTimeout(n,t)):k[0].pause()}};k.off("."+ae),n()}u.fadeOut(i.speed,function(){SMALLSCREEN||exitFullscreen(function(){u.removeClass("fullscreen")}),A.length&&(A.remove(),A=e()),M.length&&(M.remove(),M=e()),!1!==i.onClose&&i.onClose(I),Ne(),a.hideAllTooltips()})}else SMALLSCREEN||exitFullscreen(function(){u.removeClass("fullscreen")}),!1!==i.onClose&&i.onClose(I)},ye=function(e){clearTimeout(Z),b&&(b.hide(),w.show()),a.add(u).addClass(i.immerseClass),i.autohideControls&&Re(),M.addClass("slideshow"),!0!==e&&i.backgroundAudioSlideshowControl&&ie.trigger("fadeInPlayer"),i.slideshowFullscreen&&requestFullscreen(function(){u.addClass("fullscreen")}),requestWakeLock(),X?(Z=null,W=!0,ke(He)):(W=!1,Z=setTimeout(He,i.slideshowDelay/4)),!1!==i.onSlideshowStart&&i.onSlideshowStart(I)},xe=function(){b&&(b.hide(),w.show()),i.autohideControls&&Re(),a.add(u).addClass(i.immerseClass),Z=setTimeout(He,i.slideshowDelay/4),W=!1,i.backgroundAudioSlideshowControl&&ie.trigger("fadeInPlayer")},Pe=function(e){var o=null!==Z;return!1!==i.onSlideshowPause&&i.onSlideshowPause(I),!0!==e&&i.backgroundAudioSlideshowControl&&ie.trigger("fadeOutPlayer"),b&&(b.show(),w.hide()),clearTimeout(Z),Z=null,W=!1,M.show().removeClass("slideshow"),a.add(u).removeClass(i.immerseClass),Ne(),i.slideshowFullscreen&&!i.lightboxFullscreen&&exitFullscreen(function(){u.removeClass("fullscreen")}),releaseWakeLock(),!1!==i.onSlideshowPause&&i.onSlideshowPause(I),o},Ie=function(){i.backgroundAudioSlideshowControl&&ie.trigger("fadeOutPlayer"),clearTimeout(Z),Z=null,W=!0},Ae=function(e){N.length&&e.length&&e.css("width",100*N[0].currentTime/N[0].duration+"%")},Oe=function(){N.length&&N[0].play().then(function(){var o=D.find(".audioclip-btn"),t=o.find(".progress");o.removeClass("icon-volume-up").addClass("icon-pause"),N.parent().removeClass("paused").addClass("playing"),Z&&Ie(),t.length||(t=e("<div>",{class:"progress"}).appendTo(o)),Ae(t),X=setInterval(Ae,100,t),N.on("ended",function(){o.removeClass("icon-pause").addClass("icon-volume-up"),N.parent().removeClass("playing").addClass("paused"),W&&xe(),t.remove(),clearInterval(X)})},function(e){btn.removeClass("icon-pause").addClass("icon-volume-up"),console.log(e)})},Se=function(){if(N.length){var e=D.find(".audioclip-btn");N[0].pause(),clearInterval(X),e.removeClass("icon-pause").addClass("icon-volume-up"),N.parent().removeClass("playing").addClass("paused"),W&&xe()}},ke=function(e,o){N.length&&typeof e===FUNCTION&&(N[0].paused?typeof o!==UNDEF?e.apply(null,o):e.call(null):N.on("ended",e,o))},Me=function(){i.muteBackgroundAudio&&(se=!ie.data("paused"))&&ie.trigger("fadeOutPlayer"),Oe(),A.addClass(i.playingClass)},Ee=function(){i.muteBackgroundAudio&&se&&ie.trigger("fadeInPlayer"),Se(),A.removeClass(i.playingClass)},De=function(){i.muteBackgroundAudio&&(se=!1),Se(),A.removeClass(i.playingClass)},Fe=function(e){var o=(e||u).find("audio,video").eq(0);if(o.length){var t=o[0].volume,a=i.speed/(50*t),n=function(){if(o){var e=Math.max(o[0].volume-.02,0);e>.005?(o[0].volume=e,setTimeout(n,a)):o[0].pause()}};o.off("volumechange."+ae),n()}},Ne=function(){clearTimeout(Y),a.add(u).removeClass(i.immerseClass)},Je=function(){var e;if(clearTimeout(Y),e=document.querySelectorAll(":hover"))for(var o in e)if("panels"===e[o].id)return void Re();a.hideAllTooltips(),a.add(u).addClass(i.immerseClass)},Re=function(){clearTimeout(Y),Y=setTimeout(function(){Je()},Z?Math.min(i.slideshowDelay/2,i.hideControlsDelay):i.hideControlsDelay)},Le=function(){a.add(u).toggleClass(i.immerseClass,!ze())},ze=function(){return a.hasClass(i.immerseClass)},Ue=function(){u.addClass(i.captionVisibleClass)},Ve=function(){u.removeClass(i.captionVisibleClass)},Be=function(){ze()?(Ne(),u.hasClass(i.captionVisibleClass)||Ue()):(Je(),Ve()),savePrefs(i,i.prefsKept,"lb_pref"),me(!0)},Ge=function(){we($-1)},He=function(){we($+1)};if(ae&&function(t){o.add(document).off("."+t),e("#"+t).remove()}(ae),y.data("llb_ns",ae="llb_"+Math.floor(1e4*Math.random())),P=y.find(i.delegate),loadPrefs(i,i.prefsKept,"lb_pref"),D=e("#controls"),F=e("#panels"),function(o){u=e("<div>",{id:o,class:"lightbox "+i.captionVisibleClass}).hide().appendTo(y),c=e("<div>",{class:"lightbox-overlay"}).appendTo(u),h=e("<div>",{class:"lightbox-loading"}).append("<div>").appendTo(u);var t=e("<div>",{class:"controls"}).appendTo(u);if(i.zoomSlider){var a=e("<div>",{class:"zoom-control"});e("<a>",{class:"zoom-out button"}).on("click",function(){return ue(),!1}).appendTo(a),C=e("<input>",{name:"zoom-level",type:"range"}).on("change",function(){return re(parseInt(C.val())),!0}).appendTo(a),e("<a>",{class:"zoom-in button"}).on("click",function(){return de(),!1}).appendTo(a),f=e("<button>",{type:"button",class:"zoom-level icon-zoom-level button"}).on("click."+o,function(){return Q&&("touch"!==e("html").data("whatinput")||C.is(":visible"))&&le(),!1}).addTooltip(e("<div>",{class:"zoom-panel",stay:3e3}).append(a)).appendTo(t)}else g=e("<button>",{type:"button",class:"button zoom-in icon-expand",title:x.toggleZoom}).on("click",function(){return le(),!1}).appendTo(t),v=e("<button>",{type:"button",class:"button zoom-out icon-contract",title:x.toggleZoom}).on("click",function(){return le(),!1}).appendTo(t),C=e();P.length>1&&(b=e("<button>",{type:"button",class:"play icon-play button",title:x.slideshow}).on("click."+o,function(){return Q&&ye(),!1}).appendTo(t),w=e("<button>",{type:"button",class:"pause icon-pause button",title:x.pause}).append(e("<span>",{class:"progress"})).hide().on("click."+o,function(){return Q&&Pe(),!1}).appendTo(t),p=e("<button>",{type:"button",class:"arrow-left button"}).on("click."+o,function(){return Q&&Ge(),!1}).appendTo(u),T=e("<button>",{type:"button",class:"arrow-right button"}).on("click."+o,function(){return Q&&He(),!1}).appendTo(u)),m=e("<button>",{type:"button",class:"close icon-close button",title:x.close}).on("click."+o,function(){return Q&&Te(),!1}).appendTo(t),u.find("button").not(f).addTooltip()}(),o.on("resize."+ae,function(){clearTimeout(j),j=setTimeout(function(){clearTimeout(j),!A||!A.length||B&&isFullscreen()||me()},50)}),i.quitOnDocClick&&c.on("click."+ae,function(o){if(i.autohideControls&&ze())return Ne(),!1;A.length&&!e(o.target).is(A)&&Te()}),i.autohideControls&&t.on("mousemove."+ae,function(){Ne(),Re()}),i.enableKeyboard&&t.on("keyup."+ae,function(e){if(!Q||!A.length||u.children(".modal:visible").length||document.activeElement&&("INPUT"===document.activeElement.nodeName||"TEXTAREA"===document.activeElement.nodeName))return!0;switch(e.preventDefault(),e.keyCode){case 27:Te();break;case 33:case 37:Ge();break;case 34:case 39:He();break;case 97:case 35:we(P.length-1);break;case 103:case 36:we(0);break;case 106:case 179:Z?Pe():ye();break;case 107:i.useZoom&&(i.zoomSlider?de():le());break;case 109:i.useZoom?i.zoomSlider?ue():le():togglePanels();break;case 32:L?k[0].paused?playVideo(k[0]):k[0].pause():z?k[0].paused?k[0].play():k[0].pause():Z?Pe():ye();break;default:return!0}return!1}),i.enableMouseWheel){var qe=null;u.on("mousewheel."+ae+" DOMMouseScroll."+ae,function(o){if(Q){if(clearTimeout(qe),!A.length||e(o.target).closest("."+i.lightboxCaptionClass).length||A.hasClass("pdf")||A.hasClass("external")||u.children(".modal:visible").length)return!0;qe=i.useZoom&&i.zoomSlider&&1==o.ctrlKey?setTimeout(o.originalEvent.wheelDelta>0||o.originalEvent.detail<0?function(e){de()}:function(e){ue()},100):setTimeout(o.originalEvent.wheelDelta>0||o.originalEvent.detail<0?Ge:He,100)}return!1})}return y.on("lightboxLoad."+ae,function(e,o,t){Pe(!0),o=typeof o===NUMBER?Math.minMax(0,o,P.length):typeof o===UNDEF?0:P.index(o),!1!==i.onStart&&i.onStart(typeof o===NUMBER?P.eq(o):th),we(o),Z&&Pe(!0),t&&(typeof t===NUMBER?setTimeout(ye,t):ye())}).on("lightboxQuit."+ae,function(){return Te(),!1}).on("lightboxRemove."+ae,function(){return Pe(!0),Q=!1,P.off("."+ae),t.add(o).add(u).off("."+ae),a.add(e("html")).css("overflow",""),a.removeClass(i.lightboxOnClass),A.length?A.animate({opacity:0},i.speed,function(){u.remove(),i.lightboxFullscreen&&exitFullscreen()}):(i.lightboxFullscreen&&exitFullscreen(),u.remove()),!1}).on("stopAutoHide."+ae,function(){clearTimeout(Y)}).on("lightboxContainer."+ae,function(){return u}).on("lightboxNext."+ae,function(){return Pe(),He(),!1}).on("lightboxPrevious."+ae,function(){return Pe(),Ge(),!1}),i.hasOwnProperty("onReady")&&typeof i.onReady===FUNCTION&&i.onReady(I),i.autoStart&&i.baseSet&&ye(),this},e.fn.lightbox.defaults={delegate:".card.lbable",lightboxMainClass:"lightbox-main",currClass:"curr",lightboxCaptionClass:"lightbox-caption",lightboxOnClass:"lightbox-on",controlsClass:"controls",buttonClass:"secondary button small",activeClass:"active",scrollClass:"scroll",regionsClass:"regions",captionVisibleClass:"caption-visible",thumbsVisibleClass:"thumbs-visible",hasbuttonsClass:"hasbuttons",immerseClass:"immerse",playingClass:"playing",transitionProps:"300ms ease-out",slideshowDelay:4e3,hideControlsDelay:2500,prefsKept:["audioClipVolume"],captionVisible:!0,fitImages:!0,fitBetween:!1,fitBelowControls:!0,fitRatio:1,maxZoom:1.4,useZoom:!0,zoomSlider:!1,hiDpiThumbs:!1,hiDpiImages:!1,showFullscreen:!1,indexName:"index.html",baseSet:!0,autohideControls:!1,autoStart:!1,clickAction:"donothing",useSlideshow:!0,autoplayAudioClips:!0,backgroundAudioSlideshowControl:!1,muteBackgroundAudio:!0,use360Player:!0,lightboxFullscreen:!1,slideshowFullscreen:!1,slideshowFullscreenOnlyMobiles:!0,afterLast:"donothing",doubleClickZoom:!0,mapHeight:.8,mapApiKey:"",mapType:"hybrid",mapZoom:15,showShopBtn:!1,showFeedback:!1,showLowestPrice:!1,videoAuto:!1,videoLoop:!1,autoPano:!1,volume:.5,audioClipVolume:.75,rightClickProtect:!1,useRating:!1,jalbumRating:!1,visitorRating:!1,buttonLabels:!0,showNumbers:!1,showShare:!1,showDownload:!1,allowDownloadScaled:!1,allowDownloadOthers:!1,showMap:!1,showRegions:!0,regionsVisible:!1,printImage:!1,transitionType:"crossFadeAndSlide",speed:400,panoramaAutoDetect:1.5,panoramaTreshold:[2.5,2.5],defaultPosterSize:[628,360],preloadNext:!0,enableKeyboard:!0,enableMouseWheel:!0,quitOnEnd:!0,quitOnDocClick:!0,onStart:!1,onClose:!1,onLoadStart:!1,onLoadEnd:!1,onAfterLast:!1,onBeforeFirst:!1,onReady:!1,onSlideshowStart:!1,onSlideshowPause:!1,onVolumeChange:!1},e.fn.lightbox.text={startOver:"Start over",upOneLevel:"Up one level",backToHome:"Back to home",backToIndex:"Back to index page",nextFolder:"Next folder",nextIndex:"Next index page",atLastPageQuestion:"Where to go next?",atLastPage:"At last page",atFirstPage:"At first page",close:"Close",slideshow:"Slideshow",pause:"Pause",rating:"Rating",toggleZoom:"Toggle zoom",download:"Download",print:"Print",printLabel:"Print out this photo on your printer",mapBtn:"Map",mapLabel:"Show the photo location on map",fotomotoBtn:"Buy / Share",fotomotoTooltip:"Buy prints or digital files, share, send free eCards",mostphotosBtn:"Purchase",mostphotosLabel:"Download this image from <b>mostphotos.com</b>!",regionsBtn:"People",regionsLabel:"Show tagged people",share:"Share",shareLabel:"Share this photo over social sites",shareOn:"Share on",shopBtn:"Buy",shopLabel:"Add this item to the shopping cart",viewCartLabel:"View shopping cart",feedbackLabel:"View feedback window",metaBtn:"Photo data",metaLabel:"Display photographic (Exif/Iptc) data",viewCart:"View cart",addCart:"Add to cart",addComment:"Add comment",clickToOpen:"Click to open this document with the associated viewer!"}}(jQuery,jQuery(window),jQuery(document),jQuery("body"));
!function(e,t,a,s,n){"use strict";e.fn.selectable=function(t){t=e.extend({cardClass:"card",thumbClass:"thumb",checkboxClass:"checkbox",selectedClass:"checked",checkmarkClass:"icon-checkmark",hasSelectedClass:"has-selected",allSelectedClass:"all-selected",selectionChange:null},t);var a,n=e(this).eq(0),l=function(e){typeof t.selectionChange===FUNCTION&&t.selectionChange.call(e),s.toggleClass(t.hasSelectedClass,e>0).toggleClass(t.allSelectedClass,e===a.length)},r=function(){return a.filter("."+t.selectedClass).length},i=function(e){e.addClass(t.selectedClass).find("."+t.checkboxClass).addClass(t.checkmarkClass)},o=function(e){e.removeClass(t.selectedClass).find("."+t.checkboxClass).removeClass(t.checkmarkClass)},c=function(a){var s=e(a.target).closest("."+t.cardClass),n=r();return s.hasClass(t.selectedClass)?(o(s),n-=1,typeof t.selectionChange===FUNCTION&&t.selectionChange.call(n)):(i(s),n+=1,typeof t.selectionChange===FUNCTION&&t.selectionChange.call(n)),l(n),!1},d=function(){var s,l;(a=t.selector?n.find(t.selector):n.find("."+t.cardClass)).each(function(){e(this).find("span."+t.checkboxClass).length||(s=e(this).children("."+t.thumbClass).eq(0),(l=s.length?e("<span>",{class:t.checkboxClass}).appendTo(s):e("<span>",{class:t.checkboxClass}).prependTo(e(this))).on({click:c}))}),typeof t.selectionChange===FUNCTION&&t.selectionChange.call(r())};return d(),n.on({selectAll:function(){if(n.is(":visible")){var s=r();s<a.length&&(s=a.length,a.not("."+t.selectedClass).each(function(){i(e(this))}),typeof t.selectionChange===FUNCTION&&t.selectionChange.call(s)),l(s)}},selectNone:function(){if(n.is(":visible")){var s=r();s>0&&(s=0,a.filter("."+t.selectedClass).each(function(){o(e(this))}),typeof t.selectionChange===FUNCTION&&t.selectionChange.call(s)),l(s)}},selectInverse:function(){if(n.is(":visible")){var s=a.length-r();0===s?(a.each(function(){o(e(this))}),typeof t.selectionChange===FUNCTION&&t.selectionChange.call(0)):(a.each(function(){!function(e){e.hasClass(t.selectedClass)?o(e):i(e)}(e(this))}),typeof t.selectionChange===FUNCTION&&t.selectionChange.call(s)),l(s)}},selectRefresh:d}),this},e.fn.skin=function(a){a=e.extend({},e.fn.skin.defaults,a);var n,l=e(this),r=l,i=getTranslations({foundNTimes:"found {0} time(s)",notFound:"not found",search:"Search",searchPlaceholder:"Search...",newImages:"New images",results:"Results",reset:"Reset",label:"Label",selectedItems:"Selection",addCart:"Add to cart",fotomotoBtn:"Buy / Share",fotomotoTooltip:"Buy prints or digital files, share, send free eCards",return:"return",select:"Select",sortBy:"Sort by",sortedBy:"Sorted by",ascending:"ascending",descending:"descending",multipleSelectHint:"Use SHIFT to select range, CTRL for multiple entries",noRating:"No rating",inTheLastDay:"in the last day",inThePastNDays:"in the past {0} days",sinceMyLastVisit:"since my last visit",betweenDays:"between {0} and {1}",onDay:"on {0}",beforeDay:"before {0}",afterDay:"after {0}",imagesAdded:"Images added",imagesModified:"Images modified",imagesTaken:"Images taken",new:"New",audioClipLabel:"Play / pause the attached audio clip",more:"more",less:"less",image:"image",images:"images",audio:"audio",audio:"audios",video:"video",videos:"videos",other:"other",others:"others"}),o=e("#panels"),c=e("#controls"),d=e(),h=e(),u="story_skin",f="",p=a.indexName.split(".")[1]||"html",g=""!==window.location.hash,m=new Date/1e3,C="EUR",v=t.scrollTop(),y=null,b=!1,T=function(){var e=O();if(e.length){var t=e.data("overlay");return t||(t=e.hasClass(a.baseOverlayClass)?"base":w(),e.attr("data-overlay",t),t)}return""},w=function(){return"oly_"+Math.floor(1e4*Math.random())},O=function(e){var t=r.find("."+a.baseOverlayClass+":visible,."+a.overlayClass+":visible").last();return!t.length&&typeof e!==UNDEF&&e&&(t=P()),t},N=function(){return r.find("."+a.baseOverlayClass)},A=function(){var e=O();(e.length&&e.offset().top<t.scrollTop()||e.offset().top>t.scrollTop()+t.height()-100)&&t.scrollTop(e.offset().top)},P=function(){var t=w(),s=e("<article>",{class:a.contentClass+" "+a.overlayClass}).attr({id:t,"data-overlay":t}),n=N();return n.length?n.after(s):r.prepend(s),D(s),l.addClass(a.hasOverlayClass),s},E=function(){return O().children("header").eq(0)},x=function(t){var s=E().find("h"+a.overlayHeadLevel).eq(0);return s.length?t.appendTo(s):e()},k=function(){return e("<div>",{class:a.progressbarClass}).insertAfter(E())},I=function(e){O().find("."+a.progressbarClass).remove()},R=function(e){(e=e||T())&&l.find("[data-rel="+e+"]").remove()},D=function(t){var s,n=t.find("section."+a.thumbnailsClass);if(n.length){if((s=n.find("."+a.thumbContClass)).length)return s}else n=e("<section>",{class:a.thumbnailsClass}).appendTo(t);return e("<div>",{class:[a.contClass,a.thumbContClass,a.thumbLayout,a.captionClasses].filter(Boolean).join(" ")}).appendTo(n)},M=function(e){return N().find("."+a.cardClass+(e||""))},S=function(e){return O().find("."+a.cardClass+(e||""))},F=function(e){return O().find("."+a.imageClass+(e||""))},U=function(e){return O().find("."+a.cardClass+" video"+(e||""))},L=function(){return S().filter(function(){return e(this).children("."+a.selectableClass).length>0})},H=function(){var s=O();if(s.length&&s.hasClass(a.overlayClass)){var n=s.data("oly-ns");t.off("."+n),s.trigger("removeLightbox"),R(n),s.trigger("overlayRemoved"),s.remove(),Ie(),l.removeClass(a.hasOverlayClass),function(){var t=N();t.length&&(e("[data-rel="+t.data("overlay")+"]").show(),N().find("section."+a.thumbnailsClass+" ."+a.thumbContClass).trigger("refresh"))}(),$(),removeParam(a.indexName),Re();var i=L().length;Q(0,i),Z(i.length),r.hideAllTooltips()}},B=function(t){r.find("."+a.overlayClass).length>0&&H(),r.hideAllTooltips();var s=P();return function(t,s){var n=e("<header>").prependTo(s||O()),l=e("<div>",{class:[a.contClass,a.overlayTitleClass,t&&t.hasOwnProperty("icon")?t.icon:""].filter(Boolean).join(" ")}).appendTo(n);t&&t.hasOwnProperty("title")&&l.append(e("<h"+a.overlayHeadLevel+">",{html:t.title})),l.append(e("<a>",{class:"close",href:"",text:i.return}).on("click",function(){return H(),!1}))}(t,s),r.trigger("overlayReady",s),s},G=function(t,s){var n,l=e();return n=typeof s!==UNDEF&&s?M(" ."+a.imageClass):S(" ."+a.imageClass),t=decodeURIComponent(t),n.each(function(){var s=e(this).data("name")||function(e){var t=e.data("href")||e.attr("href");return t?t.substring(t.lastIndexOf("/")+1).replace("#img=",""):""}(e(this));if(s===t||function(e,t){return e.slice(-p.length)===p&&e.substring(0,e.lastIndexOf("."))===t.substring(0,t.lastIndexOf("."))}(s,t))return l=e(this).closest("."+a.cardClass),!1}),l},q=function(e){return O().find("."+a.folderCardClass+(e||""))},V=function(t){return e("[data-map-root]")},_=function(){return O().find("."+a.lightboxClass).last()},z=function(e,t){Ie(),te(F(" .playing")),a.autoplayVideoInView&&ae(),O().trigger("lightboxLoad",typeof t===UNDEF?e:[e,t])},j=function(){var t=[];return S().filter(function(){return e(this).children("."+a.selectedClass).length>0}).each(function(){t.push(e(this).data(J.OBJ))}),t},W=function(){var t=[];return S().each(function(){t.push(e(this).data(J.OBJ))}),t},Y=function(){var t=[];return M().each(function(){t.push(e(this).data(J.OBJ))}),t},K=function(){var e=S("."+a.activeClass).eq(0);return e.length?e.data(J.OBJ):null},Q=function(e,t){var s=d.add(h);typeof t!==UNDEF&&t?(s.find("."+a.selectBoxClass).show(),s.find("."+a.selectNoneClass+",."+a.addSelectedClass+",."+a.keepSelectedClass).toggleClass(a.disabledClass,typeof e===UNDEF||0===e),s.find("."+a.selectAllClass).toggleClass(a.disabledClass,typeof t!==UNDEF&&e===t)):s.find("."+a.selectBoxClass).hide()},Z=function(e){c.find("[data-rel-shop],[data-rel-feedback]").toggleClass(a.disabledClass,!e)},$=function(){e(a.search.hook).find("input").val("")},X=function(t){var s,n=e(this);return t.preventDefault(),n[0].hasAttribute("rel")&&(s=e("#"+n.attr("rel"))),s&&s.length||(n.attr("rel","PL_"+Math.floor(1e4*Math.random())),s=function(t){var s=e("<audio>",{class:"audioclip-player",src:t.attr("href"),id:t.attr("rel"),controlsList:"nofullscreen nodownload noremote noplaybackrate"}).hide().insertAfter(t);return s[0].volume=a.audioClipVolume,s}(n)),s[0].paused?(ee(),s[0].play().then(function(){n.removeClass("icon-volume-up paused").addClass("icon-pause playing"),s.on("ended",function(){n.removeClass("icon-pause playing").addClass("icon-volume-up paused")})},function(e){n.removeClass("icon-pause playing").addClass("icon-volume-up paused"),console.log(e)})):(s[0].pause(),n.removeClass("icon-pause playing").addClass("icon-volume-up paused")),!1},ee=function(){te(F(" .playing"))},te=function(t){t.each(function(){var t=e("#"+e(this).attr("rel"));t.length&&(t[0].pause(),e(this).removeClass("icon-pause playing").addClass("icon-volume-up paused"))})},ae=function(e){(e=typeof e===UNDEF?U():e).each(function(){this.paused||this.pause()})},se=function(t){if((t=typeof t===UNDEF?U():t).length){var a=window.pageYOffset,s=window.outerHeight,n=t.filter(function(){return"VIDEO"===this.nodeName&&!this.paused}),l=t.filter(function(){var t=e(this).offset().top,n=e(this).height();return t+n/3>a&&t+2*n/3<a+s});l.length>1&&(l=l.sort(function(){return a+s/2-(e(this).offset().top+e(this).height()/2)}).eq(0)),!n.length||l.length&&n===l||n[0].pause(),!l.length||n.length&&n===l||playVideo(l[0])}},ne=function(t){if(t&&t.length){for(var a=[],s=0;s<t.length;s++)a.push(t[s].hasOwnProperty(J.VISITORRATING)?t[s][J.VISITORRATING]:-1);e.cookie(REL_PATH+PAGE_NAME+":ratings",a,604800)}};e.fn.renderImages=function(l,r,o){if(typeof l===UNDEF||!l.length)return this;Array.isArray(l)||(l=[l]);var c=e(this),u=T(),f=_(),p=function(e){var t=O().find("section."+a.thumbnailsClass+" ."+a.thumbContClass);return!t.length&&e&&(t=D(O(!0))),t}(!0),g=t.scrollTop(),C="patchwork"===a.thumbLayout,v=null,y=null,b=!1,w=function(){if(!b){clearTimeout(y);var s=t.scrollTop();if(Math.abs(s-g)>20)return g=s,void(y=setTimeout(w,a.scrollCheckInterval));if(g=s,f.is(":hidden")){b=!0,S("."+a.preloadClass).removeClass(a.preloadClass);var l=t.height();S("."+a.lazyloadClass).each(function(){var t=e(this),s=t.find("."+a.imageClass);if(t.offset().top<g+l-20){var r=s.find("img").eq(0);!r.length||typeof r.attr("src")!==UNDEF&&!1!==r.attr("src")?t.hasClass(a.appearClass)||t.removeClass(a.disappearClass).addClass(a.appearClass):r.one("load",function(){e(this).hasClass(a.appearClass)||e(this).removeClass(a.disappearClass).addClass(a.appearClass)}).attr("src",n.getOptimalThumbPath(t.data(J.OBJ),[s.width(),s.height()])),t.removeClass(a.lazyloadClass)}})}y=setTimeout(w,a.scrollCheckInterval),b=!1}},N=function(t,a){var s="";return t.each(function(t){var a=e(this).data("ar");s+=a>=1.25?"l":a<=.8?"p":"s",e(this).addClass("th"+(t+1))}),t.wrapAll(e("<div>",{class:"grid-cell grid-"+s+(typeof a!==UNDEF?" "+a:"")})),t.eq(0).parent()},A=function(){var t=p.children("."+a.cardClass);t.length<=a.columns?function(t){t.each(function(t){e(this).addClass("th"+(t+1))}),t.wrapAll(e("<div>",{class:"grid-row"+(t.length>a.columns/2?" stretch":"")}))}(t):(a.columns<3?N(t.slice(0,2*a.columns)):function(t){for(var s,n=1,l=a.columns<4?2:Math.floor(a.columns/2+Math.random());t.length;){var r;r=t.length<=4?t.length:t.length<=8?Math.floor(t.length/2+Math.random()-.5):Math.min(a.columns,4),s=n>1?s.add(N(t.slice(0,r),"col-"+n)):N(t.slice(0,r),"col-1"),t=t.slice(r),n>=l?(s.wrapAll(e("<div>",{class:"grid-col"})),n=1):n++}}(t),t.length>2*a.columns&&A())},P=function(){y=setTimeout(w,a.scrollCheckInterval/2),c.on({setactivecard:function(e,t){F(t)},refreshRating:U,refresh:I}),typeof r===FUNCTION&&(typeof o!==UNDEF?r.call(void 0,c,o):r.call(void 0,c))},E=null,x=function(t){var s=O();if(clearTimeout(E),s.is(":visible")){var n=s.find("."+a.thumbnailsClass);if(n.length){var l=n.eq(0).children("."+a.contClass).width();if(s.data("fixedfor")!==l){var r=function(t,s){s>1.6&&(s=1.6);var n=Math.floor(a.thumbDims[1]*s);t.each(function(){e(this).css({width:e(this).data("width")*(s||1)}),e(this).children("."+a.imageClass).css({height:n})})};n.each(function(){var t=e(this).children("."+a.contClass).eq(0);requestAnimationFrame(function(){!function(e){for(var t,n=0,i=0;e.length&&n<e.length;)i+(t=e.eq(n).data("width")+2*a.thumbGap)>=l?(i+t/2>=l?(r(e.slice(0,n),.999*(l-2*n*a.thumbGap)/(i-2*n*a.thumbGap)),e=e.slice(n)):(r(e.slice(0,n+1),.999*(l-2*(n+1)*a.thumbGap)/(i+t-2*(n+1)*a.thumbGap)),e=e.slice(n+1)),n=0,i=0):(n++,i+=t);e.length&&r(e,Math.min(1.125,l/i)),s.data("fixedfor",l)}(t.children("."+a.cardClass))})}),typeof t===FUNCTION&&t.call()}}}else E=setTimeout(x,100)},k=function(){v=setTimeout(function(){I()},a.scrollCheckInterval/2)},I=function(){if(!f.is(":visible")){clearTimeout(v),v=null;var s=t.scrollTop(),n=t.height();if(Math.abs(s-g)>20)return g=s,void(v=setTimeout(I,a.scrollCheckInterval));var l=S("."+a.lazyloadClass).not(":empty");(l=l.add(S("."+a.preloadClass).not(":empty").not(".icon").filter(function(){var t=e(this).find("."+a.imageClass),s=t.find("img").eq(0);return!(!s.data("hasrenditions")||!(1.05*s[0].naturalWidth<t.width()||1.05*s[0].naturalHeight<t.height()))}))).length?(l.each(function(){var t=e(this),a=t.offset().top;if(a+t.height()>g-n){if(!(a<g+2*n))return!1;M(t)}}),g=s,v=setTimeout(I,a.scrollCheckInterval)):t.off("scroll."+u)}},R=function(t){return!("A"!==t.target.nodeName||!e(t.target).closest("."+a.commentClass).length&&!e(t.target).hasClass("folder-link"))||(s.hideAllTooltips(),z(e(t.target).closest("."+a.cardClass)),!1)},M=function(t){if(t.length){var s=t.children("."+a.imageClass).eq(0),l=s.children("img");l.length||s.append(e("<img>",{class:a.disappearClass})),t.hasClass(a.lazyloadClass)&&typeof l.attr("src")!==UNDEF&&!1!==l.attr("src")?s.addClass(a.appearClass).removeClass(a.disappearClass):(t.hasClass(a.lazyloadClass)&&l.one("load",function(){e(this).addClass(a.appearClass).removeClass(a.disappearClass)}),l.attr("src",n.getOptimalThumbPath(t.data(J.OBJ),[s.outerWidth(),s.outerHeight()],!a.fixedShapeThumbs))),t.removeClass(a.lazyloadClass+" "+a.preloadClass)}},F=function(s){if(s){var l=e(s),r=l.data(J.OBJ),i=t.height(),o=t.scrollTop(),c=l.offset().top,d=l.outerHeight();S("."+a.activeClass).removeClass(a.activeClass),l.addClass(a.activeClass),a.hasOwnProperty("map")&&(n.hasLocation(r)?V().trigger("setActive",r[J.NAME]):V().trigger("resetMarkers")),c+d>o+i?e("html, body").stop(!0,!1).animate({scrollTop:Math.round(c-i+d+30)+"px"}):c<o&&e("html, body").stop(!0,!1).animate({scrollTop:Math.round(Math.max(c-30,0))+"px"})}},U=function(t,s,n){if(s){var r=e(s),i=r.data(J.OBJ),c=(typeof n!==UNDEF?n:a.visitorRating?i[J.VISITORRATING]:i[J.RATING])||0;r.find(".rating").removeClass("r0 r1 r2 r3 r4 r5").addClass("r"+c),o?ne(l):G(i[J.NAME],!0).find(".rating").removeClass("r0 r1 r2 r3 r4 r5").addClass("r"+c)}};return u||(u="base"),o||(l.length>a.columns?p.addClass("multi"):p.addClass("cnt-"+l.length)),o&&a.useRating&&a.visitorRating&&function(t){var a=e.cookie(REL_PATH+PAGE_NAME+":ratings");if(a){typeof a===STRING&&(a=a.split(":"));for(var s=0;s<t.length&&s<a.length;s++)-1!==a[s]&&(t[s][J.VISITORRATING]=a[s])}}(l),window.requestAnimationFrame(function(){for(var s,r,c,f,g,v,y,b,T,w,O,N,I=S(),D=a.hasOwnProperty("markNew")?m-a.markNew.days*ONEDAY_S:null,M=0;M<l.length;M++){if(N=l[M],g="folder"===N[J.CATEGORY],y=!g&&n.isLightboxable(N),b="video"===N[J.CATEGORY]||"audio"===N[J.CATEGORY],T=!!N.hasOwnProperty(J.THUMB)&&/res\/\w+\.png$/.test(N[J.THUMB][J.PATH]),w=N[J.THUMBCAPTION],M<I.length?s=I.eq(M):(r=N.hasOwnProperty(J.THUMB)?N[J.THUMB][J.WIDTH]/N[J.THUMB][J.HEIGHT]:1,s=e("<div>",{class:[a.cardClass,a.lazyloadClass,N[J.CATEGORY],w?"hascaption":"",T?"icon":"",b?"media":"",r>=1.25?"landscape":r<=.8?"portrait":"square"].filter(Boolean).join(" ")}).data("ar",r).appendTo(p)),y&&s.addClass(a.lbableClass),s.data(J.OBJ,N),(v=s.closest("section").hasClass(a.thumbnailsClass))||!b?((c=s.children("."+a.imageClass)).length||(c=e("<a>",{class:[a.imageClass,T?"iconthumb":"",N[J.THUMB][J.WIDTH]<a.thumbDims[0]&&N[J.THUMB][J.HEIGHT]<a.thumbDims[1]?"tiny":""].filter(Boolean).join(" ")}).appendTo(s)),(f=c.find("img").eq(0)).length||(f=e("<img>",{class:a.disappearClass,alt:n.getAlt(N)}).appendTo(c)),y&&c.on("click."+u,R)):((f=s.find("video,audio")).length||(f=e("<"+N[J.CATEGORY]+">",{class:a.disappearClass,alt:n.getAlt(N)}).appendTo(s)),s.find(".opener").on("click."+u,R)),N[J.THUMB].hasOwnProperty(J.RENDITIONS)?f.data("hasrenditions",!0):f.one("load."+u,function(){e(this).parents("."+a.cardClass).removeClass(a.preloadClass)}),f[0].complete&&f.trigger("load"),T?c.addClass("iconthumb"):v?(f.attr({width:N[J.THUMB][J.WIDTH],height:N[J.THUMB][J.HEIGHT]}),N[J.THUMB][J.HEIGHT]/N[J.THUMB][J.WIDTH]<.5&&s.addClass(a.panoClass)):b||f.attr({width:N[J.IMAGE][J.WIDTH],height:N[J.IMAGE][J.HEIGHT]}),"masonry"===a.thumbLayout?s.css({flexBasis:Math.round(.9*N[J.THUMB][J.WIDTH])}):"justified"===a.thumbLayout&&s.data("width",N[J.THUMB][J.WIDTH]),c.data("name")||c.attr("data-name",n.getItemName(N)),w&&(s.children("."+a.captionClass).length||e("<div>",{class:a.captionClass,html:w}).appendTo(s),s.addClass(a.hascaptionClass)),y){c[0].hasAttribute("href")&&c.attr("href","");var F=d.length&&n.hasShop(N);if((F||h.length&&a.feedback)&&c.addClass(a.selectableClass),F&&(O=e("<a>",{class:"icon-shopping-cart add-cart",text:" "+i.addCart}).on("click."+u,function(t){var s=e(t.target).closest("."+a.cardClass);return s.length&&d.trigger("addItems",s.data(J.OBJ)),!1}).appendTo(c)).addTooltip(n.getPriceRange(N)),LOCAL&&!DEBUG||F||!a.hasOwnProperty("fotomoto")||n.hideFotomoto(N)||(O=e("<a>",{class:"icon-shopping-cart add-cart fotomoto-btn",text:" "+i.fotomotoBtn}).on("click."+u,function(t){if(t.preventDefault(),typeof FOTOMOTO!==UNDEF){var s=e(t.target).closest("."+a.cardClass);s.length&&FOTOMOTO.API.showWindow(10,n.getOriginalPath(s.data(J.OBJ))||n.getItemPath(s.data(J.OBJ)))}return!1}).appendTo(c)).addTooltip(i.fotomotoTooltip),!o&&a.linkToFolder){var U=n.getPath(N);U&&c.append(e("<a>",{class:"icon-folder folder-link",href:U+a.indexName}))}a.useAudioClipButton&&N.hasOwnProperty(J.AUDIOCLIP)&&(w=e("<a>",{class:"icon-volume-up audioclip",href:N[J.AUDIOCLIP][J.PATH]}).on("click",X).appendTo(c),TOUCHENABLED||w.data("tooltip",i.audioClipLabel).addTooltip())}else s.addClass(N[J.CATEGORY]),c.attr("href",n.getItemPath(N));if(null!=D&&(O=N[J.DATES])&&(O=O[a.markNew.reference])&&O>=D&&(w=a.markNew.text?e("<span>",{class:"new-image",text:a.markNew.text}):e("<span>",{class:"icon-new-fill new-image"}),c.append(w),TOUCHENABLED||w.data("tooltip",new Date(1e3*O).toLocaleDateString(LOCALE)).addTooltip()),a.useRating&&y){var L=N[J.RATING]||0;(a.visitorRating||L)&&(w=e("<span>",{class:"rating",html:STARS}).appendTo(c),a.visitorRating?(N.hasOwnProperty(J.VISITORRATING)?L=N[J.VISITORRATING]:(a.useJalbumRating||(L=0),N[J.VISITORRATING]=L),w.addClass("r"+L+(a.useJalbumRating?"":" icon-close")).on("click."+u,function(t){var s=e(this),n=Math.minMax(0,Math.floor((getCoords(t).x-s.offset().left-parseFloat(s.css("paddingLeft")))/16),5),r=s.closest("."+a.cardClass).data(J.OBJ);return s.removeClass("r0 r1 r2 r3 r4 r5").addClass("r"+n),r[J.VISITORRATING]=n,o?ne(l):(s=G(r[J.NAME],!0)).length&&(s.find(".rating").removeClass("r0 r1 r2 r3 r4 r5").addClass("r"+n),s.data(J.OBJ)[J.VISITORRATING]=n,ne(Y())),!1})):w.addClass("r"+L))}a.rightClickProtect&&c.on("contextmenu",function(e){return e.preventDefault(),!1})}!o&&C&&p.length&&p.not(":empty")&&A(),"justified"===a.thumbLayout?(x(k),t.on("resize."+u+" orientationchange."+u,function(e){return clearTimeout(E),E=setTimeout(x,500),!0})):k(),window.requestAnimationFrame(P)}),this};var le=function(t,s){if(n){var l=S();if(l.length>1&&e(".filter-cont").length&&xe(s),l.filter("."+a.lbableClass).length){if(n.hasShop()||a.feedback){var r=L();Q(0,r.length),Z(r.length),r.length&&(t.selectable({cardClass:a.selectableClass,selectedClass:a.selectedClass,selectionChange:function(){Q(this,r.length),d.add(h).trigger("itemsSelected",this)}}),d.add(h).find("."+a.keepSelectedClass).on("click."+u,function(){return oe(i.selectedItems,function(){removeParam(),Re()}),!1}))}a.hasOwnProperty("map")&&(a.map.hasOwnProperty("apiKey")&&(e.fn.lightbox.defaults.mapApiKey=a.map.apiKey),a.map.hasOwnProperty("type")&&(e.fn.lightbox.defaults.mapType=a.map.type),a.map.hasOwnProperty("zoom")&&(e.fn.lightbox.defaults.mapZoom=a.map.zoom),De(W(),a.map)),t.trigger("lightboxRemove"),t.lightbox(n,{baseSet:typeof s!==UNDEF&&s,onLoadStart:function(e){var s=e.data(J.OBJ);t.trigger("setactivecard",e),s&&(addParam(a.pageName||a.indexName,{img:n.getItemName(s)},s[J.TITLE]),n.hasLocation(s)?setTimeout(function(){V().trigger("setActive",s[J.NAME])},50):V().trigger("resetMarkers"),setTimeout(Re,100))},onClose:function(){a.slideshowFullscreen&&!a.slideshowFullscreenOnlyMobiles&&exitFullscreen(),removeParam(a.pageName||a.indexName,"img"),Re()},onVolumeChange:function(e){a.audioClipVolume=e},onReady:function(){if(g&&window.location.hash){g=!1;var t=readParam();if(t.hasOwnProperty("label")&&null!==t.label)he(t.label,function(){addParam(a.indexName,{label:t.label+"",search:null,newimages:null,date:null},i.label+": "+t.label)});else if(t.hasOwnProperty("search")&&null!==t.search)ce(t.search,function(){addParam(a.indexName,{search:t.search+"",label:null,newimages:null,date:null},i.search+": "+t.search)});else if(t.hasOwnProperty("newimages"))Ce(fe(t.newimages),function(){addParam(a.indexName,{newimages:t.newimages,search:null,label:null,date:null},i.searchNew+": "+t.newimages)});else if(t.hasOwnProperty("date")){var s=pe(t.date);Ce(s,function(){addParam(a.indexName,{date:t.date,newimages:null,search:null,label:null},ge(s.reference)+": "+t.date)})}else if(t.hasOwnProperty("img")&&null!==t.img){var n=G(t.img);n.length?t.hasOwnProperty("slideshow")?z(n,2e3):z(n):removeParam(a.pageName||a.indexName,"img")}else t.hasOwnProperty("slideshow")&&z(0,2e3)}e("."+a.startshowClass).fadeIn().on("click",function(){return e(this).trigger("removeTooltip"),ie(),!1})},onSlideshowStart:function(){a.hasOwnProperty("backgroundMusic")&&a.backgroundMusic.slideshowControl&&e(a.backgroundMusic.hook).trigger("startPlayer")},onSlideshowPause:function(){a.hasOwnProperty("backgroundMusic")&&a.backgroundMusic.slideshowControl&&e(a.backgroundMusic.hook).trigger("pausePlayer")}})}else e("."+a.startshowClass).fadeOut()}},re=function(){if(window.location.hash!==f){f=window.location.hash;var e=readParam();if(e.hasOwnProperty("label"))he(e.label,function(){setParam(a.indexName,{label:e.label},i.label+": "+e.label),Re()});else if(e.hasOwnProperty("search"))ce(e.search,function(){setParam(a.indexName,{search:e.search},i.search+": "+e.search),Re()});else if(e.hasOwnProperty("newimages"))Ce(fe(e.newimages),function(){setParam(a.indexName,{newimages:e.newimages},i.newImages+": "+e.newimages),Re()});else if(e.hasOwnProperty("date")){var t=pe(e.date);Ce(t,function(){setParam(a.indexName,{date:e.date},ge(t.reference)+": "+e.date),Re()})}else if(e.hasOwnProperty("img")){var s=G(e.img);s.length?e.hasOwnProperty("slideshow")?z(s,2e3):z(s):removeParam(a.indexName,"img")}else e.hasOwnProperty("slideshow")?z(0,2e3):(Ie(),O().trigger("lightboxQuit"),a.autoplayVideoInView&&se(),H())}},ie=function(t){var s=e();return a.restartSlideshow||(s=S("."+a.activeClass)),s.length||(s=S().eq(0)),!a.slideshowFullscreen||a.slideshowFullscreenOnlyMobiles&&!SMALLSCREEN||requestFullscreen(function(){_().addClass("fullscreen")}),z(s,2e3),!1},oe=function(t,s){var n=j();if(n.length&&n.length!==S("."+a.lbableClass).length){var l=B({className:"selected-items",icon:"icon-checkbox-checked",title:"&ldquo;"+t+"&rdquo;"});x(e("<small>",{text:i.foundNTimes.replace("{0}",n.length)})),A(),setTimeout(function(){l.renderImages(n,le),Q(0,n.length),Z(n.length),typeof s===FUNCTION&&s.call()},50)}},ce=function(t,s){var l=B({className:"search-results",icon:"icon-search",title:"&ldquo;"+t+"&rdquo;"});k(),A(),n.collectItems(e.extend(a.search,{exact:!1,terms:t,depth:"tree",ready:function(){x(e("<small>",{text:this.length?i.foundNTimes.replace("{0}",this.length):i.notFound})),l.renderImages(this,le),I(),Q(0,this.length),Z(this.length),typeof s===FUNCTION&&s.call()}}))},de=function(t){if(t.length&&n){a.search=e.extend({depth:"tree",fields:"creator,keywords,title,comment"},a.search);var s=function(e){var t=e.find("input").eq(0).val();return t&&t.length>1&&ce(t,function(){setParam(a.indexName,{search:t},i.search+": "+t),Re()}),!1};t.find(".search-btn").on("click",function(){return t.hasClass(a.activeClass)?(s(t),t.removeClass(a.activeClass)):(t.find("input").eq(0).focus(),t.addClass(a.activeClass)),!1}),t.on("submit",function(e){return e.preventDefault(),s(t),t.removeClass(a.activeClass),!1}),t.find("input").on("focus",function(){t.addClass(a.activeClass)})}},he=function(t,s,l){var r=B({className:"tags-found",icon:"icon-tag",title:"&ldquo;"+t+"&rdquo;"});k(),A(),typeof s===UNDEF?s=!1:typeof s===FUNCTION&&(l=s,s=!1),n.collectItems(e.extend(a.tagCloud,{exact:a.exactFields,caseSensitive:s,terms:t,ready:function(){x(e("<small>",{text:this.length?i.foundNTimes.replace("{0}",this.length):i.notFound})),r.renderImages(this,le),I(),Q(0,this.length),Z(this.length),typeof l===FUNCTION&&l.call()}}))},ue=function(t){var s=e(a.tagCloud.hook||".tag-cloud-cont");if(s.length)if(t.length){var l=s.children("."+a.tagCloudClass),r=function(){var t=e(this).children("span").eq(0).text();return t&&t.length>1&&function(t,a,s){var l=B({className:"tags-found",icon:"icon-tag",title:"&ldquo;"+t+"&rdquo;"});k(),A(),n.collectByPath({paths:a,ready:function(){x(e("<small>",{text:this.length?i.foundNTimes.replace("{0}",this.length):i.notFound})),l.renderImages(this,le),I(),typeof s===FUNCTION&&s.call()}})}(t,e(this).data("paths"),function(){setParam(a.indexName,{label:t},i.label+": "+t),Re()}),!1};l.length||(l=e("<div>",{class:a.tagCloudClass}).appendTo(s));for(var o,c,d,h=0,u=t.length;h<u;h++){if(o=e("<a>",{class:"tag"}).on("click",r).data("paths",t[h][1]).append(e("<span>",{html:t[h][0]})),t[h][1].length>1){if(a.tagCloud.fontVaries){for(c=0,d=Math.min(64,t[h][1].length);d>1;)c++,d>>=1;o.addClass("size-"+c)}o.append("&nbsp;").append(e("<sup>",{text:t[h][1].length}))}l.append(o)}l.outerHeight()>175&&function(t){var s;t.css({maxHeight:150,overflow:"hidden"}),(s=e("<div>",{class:"toggle-height"}).insertAfter(t)).append(e("<a>",{class:"icon-caret-down",text:i.more}).on("click",function(){var e=t.parent();e.css({height:e.height(),overflow:"hidden"}),t.css({maxHeight:"none"}),setTimeout(function(){var n=t.prop("scrollHeight");e.css({height:"auto",overflow:"visible"}),t.css({maxHeight:150}),setTimeout(function(){t.css({maxHeight:n+20})},25),s.addClass(a.activeClass)},50)})).append(e("<a>",{class:"icon-caret-up",text:i.less}).on("click",function(){t.css({maxHeight:150}),s.removeClass(a.activeClass)}))}(l),a.tagCloud.useSearch&&function(t){var s=t.find("."+a.tagSearchClass),n=function(e){var t=e.find("input").eq(0).val();return t&&t.length>1&&he(t,function(){setParam(a.indexName,{label:t},i.label+": "+t),Re()}),!1};s.length||((s=e("<form>",{class:a.tagSearchClass}).appendTo(t)).append(e("<div>",{class:"search-input"}).append(e("<input>",{type:"text",placeholder:i.searchPlaceholder,ariaLabel:i.search}))),s.append(e("<a>",{class:"search-btn icon-search"}))),s.find(".search-btn").on("click",function(){var t=e(this).closest("form");return t.find("input").eq(0).focus(),n(t),!1}),s.on("submit",function(t){return t.preventDefault(),n(e(this)),!1})}(s.parent())}else s.remove()},fe=function(e){return a.hasOwnProperty("searchNew")?{reference:a.searchNew.reference||"dateTaken",depth:a.searchNew.depth||"subfolders",start:m/ONEDAY_S-e}:{reference:"dateTaken",depth:"subfolders",start:m/ONEDAY_S-e}},pe=function(e){var t=e.match(/^([amt])?([cts])?\:?(\d+)\-?(\d+)?/i),a={range:0,reference:"dateTaken",depth:"current"};return t&&(t[1]&&("a"===t[1]?a.added="added":"m"===t[1]?a.added="fileModified":"t"===t[1]&&(a.added="dateTaken")),t[2]&&("c"===t[2]?a.depth="current":"t"===t[2]?a.depth="tree":"s"===t[2]&&(a.depth="subfolders")),t[4]?(a.start=parseInt(t[3])||0,a.end=parseInt(t[4])):t[3]&&(a.start=parseInt(t[3]),a.range=1)),a},ge=function(e){return"dateTaken"===e?i.imagesTaken:"fileModified"===e?i.imagesModified:i.imagesAdded},me=function(e){var t,a=ge(e.reference),s=(Math.floor(new Date/ONEDAY_MS),function(e){return new Date(e*ONEDAY_MS).toLocaleDateString(LOCALE)});return e.hasOwnProperty("end")||e.hasOwnProperty("start")?e.hasOwnProperty("end")?t=i.beforeDay.template(s(e.end)):e.hasOwnProperty("start")&&(t=e.hasOwnProperty("range")?e.range>1?i.betweenDays.template(s(e.start),s(e.start+e.range)):i.onDay.template(s(e.start)):getTimespan(m/ONEDAY_S-e.start)):t=getTimespan(e.range),a+" "+t},Ce=function(t,a){var s=B({className:"search-results",icon:"icon-calendar",title:me(t)});k(),A(),n.collectByDate(e.extend(t,{ready:function(){x(e("<small>",{text:this.length?i.foundNTimes.replace("{0}",this.length):i.notFound})),s.renderImages(this,le),I(),Q(0,this.length),Z(this.length),typeof a===FUNCTION&&a.call()}}))},ve=function(t){return t&&Ce(e.extend(a.searchNew,{start:m/ONEDAY_S-t}),function(){setParam(a.indexName,{newimages:t},ge(a.searchNew.reference)),Re()}),!1},ye=function(e,t){return e.hasOwnProperty(J.DATES)?"addedDate"===t?e[J.DATES].added:"originalDate"===t?e[J.DATES].dateTaken:e[J.DATES].fileModified:null},be=function(t,s){var n=e(t.target).closest("form"),l=W(),r=l.length,o=[];if(n.find("select:visible,input[type=range],input[type=date]").each(function(){var t=this.name,s=n.find("label[for="+t+"]").text(),r=e(this).data("type"),i=e(this).val(),c=function(a){return"rating"===t?Math.round(a):"fileSize"===t?niceByte(a):"date"===r?new Date(1e3*a).toLocaleDateString(LOCALE):"numeric"===r?"seconds"===e(this).data("unit")?niceTime(a):"byte"===e(this).data("unit")?niceByte(a):a>=10?Math.round(a):a>=1?a.toFixed(1):a>=.1?a.toFixed(2):a:toCurrency(a,C)};if("numeric"===r||"date"===r||"financial"===r){var d=e(this).data("low"),h=e(this).data("high");if(d>this.min||h<this.max){if(t.endsWith("Date"))for(u=l.length-1;u>=0;u--)null!==(g=ye(l[u],t))&&g>=d&&g<=h||l.splice(u,1);else if(-1!==JCAMERAFIELDS.indexOf(t))if("exposureTime"===t)for(u=l.length-1;u>=0;u--)l[u].hasOwnProperty(J.CAMERA)&&l[u][J.CAMERA].hasOwnProperty(t)&&(g=getExposure(l[u][J.CAMERA][t]))&&g>=d&&g<=h||l.splice(u,1);else if(t.startsWith("focalLength"))for(u=l.length-1;u>=0;u--)l[u].hasOwnProperty(J.CAMERA)&&l[u][J.CAMERA].hasOwnProperty(t)&&!isNaN(g=parseInt(l[u][J.CAMERA][t]))&&g>=d&&g<=h||l.splice(u,1);else for(u=l.length-1;u>=0;u--)l[u].hasOwnProperty(J.CAMERA)&&l[u][J.CAMERA].hasOwnProperty(t)&&null!==(g=l[u][J.CAMERA][t])&&g>=d&&g<=h||l.splice(u,1);else if("rating"===t)for(var u=l.length-1,f=a.visitorRating?J.VISITORRATING:J.RATING;u>=0;u--)(g=l[u][f]||0)>=d&&g<=h||l.splice(u,1);else for(u=l.length-1;u>=0;u--)null!==(g=l[u][t])&&g>=d&&g<=h||l.splice(u,1);o.push(s+"="+c(d)+"&ndash;"+c(h))}}else if("SELECT"===this.nodeName&&null!==i&&i.length){if(Array.isArray(i)||(i=[i]),-1!==JCAMERAFIELDS.indexOf(t))for(u=l.length-1;u>=0;u--)l[u].hasOwnProperty(J.CAMERA)&&l[u][J.CAMERA].hasOwnProperty(t)&&null!==(g=l[u][J.CAMERA][t])&&i.includes(g)||l.splice(u,1);else for(var p,g,u=l.length-1;u>=0;u--){if(l[u].hasOwnProperty(t))if(g=l[u][t],Array.isArray(g)){p=!1;for(var m=0;m<i.length;m++)if(g.includes(i[m])){p=!0;break}if(p)continue}else if(i.includes(g))continue;l.splice(u,1)}this.multiple?o.push(t+"=["+i.join(",")+"]"):o.push(s+"="+i)}}),l.length<r){var c=B({className:"filtered-items",icon:"icon-filter",title:i.results});k(),A(),setTimeout(function(){x(e("<small>",{html:o.join(", ")+": "+i.foundNTimes.replace("{0}",l.length)})),c.on("overlayRemoved",Pe),c.renderImages(l,le),I(),Q(0,l.length),Z(l.length),typeof s===FUNCTION&&s.call()},50)}return!1},Te=function(t,s){var n=this.selectedOptions[0],l=this.value;if(!n||!l)return!0;var r,o,c=W(),d=(c.length,e(n).data("sort")),h=d.type,u=d.ascending;if("numeric"===h||"financial"===h||"date"===h)if(l.endsWith("Date"))c=c.sort(function(e,t){return r=ye(e,l),o=ye(t,l),u?(r||0)-(o||0):(o||0)-(r||0)});else if(-1!==JCAMERAFIELDS.indexOf(l))c="exposureTime"===l?c.sort(function(e,t){return r=e.hasOwnProperty(J.CAMERA)&&e[J.CAMERA].hasOwnProperty(l)?e[J.CAMERA][l]:0,o=t.hasOwnProperty(J.CAMERA)&&t[J.CAMERA].hasOwnProperty(l)?t[J.CAMERA][l]:0,u?getExposure(r||0)-getExposure(o||0):getExposure(o||0)-getExposure(r||0)}):c.sort(function(e,t){return r=e.hasOwnProperty(J.CAMERA)&&e[J.CAMERA].hasOwnProperty(l)?parseFloat(e[J.CAMERA][l]):0,o=t.hasOwnProperty(J.CAMERA)&&t[J.CAMERA].hasOwnProperty(l)?parseFloat(t[J.CAMERA][l]):0,u?(r||0)-(o||0):(o||0)-(r||0)});else if("rating"===l){var f=a.visitorRating?J.VISITORRATING:J.RATING;c=c.sort(function(e,t){return u?(e[f]||0)-(t[f]||0):(t[f]||0)-(e[f]||0)})}else c=c.sort(function(e,t){return e.hasOwnProperty(l)&&t.hasOwnProperty(l)?u?parseFloat(e[l])-parseFloat(t[l]):parseFloat(t[l])-parseFloat(e[l]):u?e.hasOwnProperty(l)?1:0:t.hasOwnProperty(l)?-1:0});else c=c.sort(function(e,t){return e.hasOwnProperty(l)&&t.hasOwnProperty(l)?u?(e[l]+"").localeCompare(t[l]+""):(t[l]+"").localeCompare(e[l]+""):u?e.hasOwnProperty(l)?1:0:t.hasOwnProperty(l)?-1:0});var p=B({className:"sorted-items",icon:"icon-ordering",title:i.sortedBy+"<small>"+d.label+" ("+i[d.ascending?"ascending":"descending"]+")</small>"});return k(),setTimeout(function(){p.renderImages(c,le),p.on("overlayRemoved",Ee),I(),Q(0,c.length),Z(c.length),typeof s===FUNCTION&&s.call()},50),!1},we=function(t){(typeof t===UNDEF||t.hasOwnProperty("target")?e(this).closest("form"):t).find("button[type=reset]").removeClass("disabled")},Oe=function(t){(typeof t===UNDEF||t.hasOwnProperty("target")?e(this).closest("form"):t).find("button[type=reset]").addClass("disabled")},Ne=function(t){t.find("select").each(function(){e(this).prop("selectedIndex",this.multiple?-1:0)}),t.find("input[type=range]").each(function(){e(this).trigger("resetRange")}),Oe(t)},Ae=function(t){return Ne(e(t.target).closest("form")),!1},Pe=function(){Ee(),Ne(e("#filters form.filter"))},Ee=function(){e("#filters form.sort select").prop("selectedIndex",0)},xe=function(t){var s,l,r,o,c,d=W(),h=n.getPropertyObject(n.getCurrentFolder(),J.FILTERS,!0),f=n.getPropertyObject(n.getCurrentFolder(),J.SORT,!0),p=e(),g=e(),m=e();if((h||f)&&d.length>1){if(t?g=(p=e("#filters")).find("form.filter"):((p=e("<div>",{class:"box filter-cont",id:"filters_"+T()}).insertBefore(e("#filters").hide())).append(e("<h"+a.overlayHeadLevel+">",{class:"icon-"+(h?"filter":"ordering"),text:e("#filters").find("."+a.overlayTitleClass).text()})),g=e("<form>",{class:"filter"}).appendTo(p)),o=e("<div>",{class:"buttons"}).appendTo(g),function(t){if(t.length){var a=T();t.each(function(){e(this).attr("data-rel",a)})}}(p),h){h=function(e,t){if(t&&e.length){var s=function(e,t){e.hasOwnProperty("min")&&e.hasOwnProperty("min")?e.min>t?e.min=t:e.max<t&&(e.max=t):e.min=e.max=t};for(var n in t){var l=t[n],r=l.type;if("numeric"===r||"date"===r||"financial"===r)if(n.endsWith("Date"))for(i=e.length-1;i>=0;i--)null!==(c=ye(e[i],n))&&s(l,c);else if(-1!==JCAMERAFIELDS.indexOf(n))if("exposureTime"===n)for(i=e.length-1;i>=0;i--)e[i].hasOwnProperty(J.CAMERA)&&e[i][J.CAMERA].hasOwnProperty(n)&&(c=getExposure(e[i][J.CAMERA][n]))&&s(l,c);else if(n.startsWith("focalLength"))for(i=e.length-1;i>=0;i--)e[i].hasOwnProperty(J.CAMERA)&&e[i][J.CAMERA].hasOwnProperty(n)&&!isNaN(c=parseInt(e[i][J.CAMERA][n]))&&s(l,c);else for(i=e.length-1;i>=0;i--)e[i].hasOwnProperty(J.CAMERA)&&e[i][J.CAMERA].hasOwnProperty(n)&&null!==(c=e[i][J.CAMERA][n])&&s(l,c);else if("rating"===n)for(var i=e.length-1,o=a.visitorRating?J.VISITORRATING:J.RATING;i>=0;i--)s(l,c=e[i][o]||0);else for(i=e.length-1;i>=0;i--)null!==(c=e[i][n])&&s(l,c);else if(l.hasOwnProperty("values")||(l.values=[]),-1!==JCAMERAFIELDS.indexOf(n))for(i=0;i<e.length;i++)e[i].hasOwnProperty(J.CAMERA)&&e[i][J.CAMERA].hasOwnProperty(n)&&pushNew(l.values,(e[i][J.CAMERA][n]+"").trim());else for(var c,i=0;i<e.length;i++)e[i].hasOwnProperty(n)&&pushNew(l.values,e[i][n])}return t}}(d,h);var C;for(var v in h){if(r=h[v].type,s=e("<div>",{class:"group "+("multiple_string"===r||"single_string"===r?"select":"range")}).insertBefore(o),h[v].label&&e("<label>",{for:v,text:h[v].label}).appendTo(s),"multiple_string"===r||"single_string"===r)if("rating"===v&&(h[v].values=[i.noRating,1,2,3,4,5]),l=e("<select>",{name:v}).appendTo(s),"multiple_string"===r&&(l.attr("multiple",!0),l.addTooltip(i.multipleSelectHint)),h[v].hasOwnProperty("values")&&h[v].values.length){if("single_string"===r&&l.prepend(e("<option>",{text:i.select,disabled:"",selected:""})),h[v].values)for(var y=0;y<h[v].values.length;y++)l.append(e("<option>",{text:h[v].values[y]}));l.on("change",we)}else s.remove();else l=e("<input>",{name:v,type:"range"}).data("type",r).appendTo(s),"rating"===v&&(h[v].step=1,h[v].min=0,h[v].max=5),h[v].hasOwnProperty("min")&&h[v].hasOwnProperty("max")&&h[v].min!==h[v].max?("financial"===r&&(C=h[v].label.match(/\S+\s+[\(\[](\S+)[\)\]]/))?h[v].currency=C[1]:"numeric"===r&&("exposureTime.shutterSpeed".indexOf(v)>=0?h[v].unit="seconds":"fileSize"===v&&(h[v].unit="byte",h[v].step=1)),h[v].onChanged=we,h[v].onReseted=Oe,l.rangeSlider(h[v])):s.remove();l.attr("data-type",r||"single_string")}(l=g.find("input,select")).length&&(g.data("single",1===l.length&&"SELECT"===l[0].nodeName&&!l.attr("multiple")),t&&g.data("single")||(c=e("<button>",{type:"reset",class:(t?"disabled secondary":"alert")+" button",text:" "+i.reset}).appendTo(o),t?c.on("click."+u,Ae):c.on("click."+u,function(){Pe(),H()})),g.data("single")?l.on("change."+u,be):((c=g.find("button[type=submit]")).length||(c=e("<button>",{type:"submit",class:"button",text:" "+i.search}).appendTo(o)),c.on("click."+u,be)),g.on("submit."+u,be))}if(o.is(":empty")&&o.remove(),f){m=t?p.find("form.sort"):e("<form>",{class:"sort"}).appendTo(void 0),e("<label>",{class:"icon-ordering",for:"sortby",text:" "}).appendTo(m),(l=e("<select>",{class:"small",name:"sortby"}).appendTo(m)).prepend(e("<option>",{text:i.sortBy,disabled:"",selected:""}));for(var b in f)l.append(e("<option>",{html:"&#8613; "+f[b].label,value:b}).data("sort",{type:f[b].type,label:f[b].label,ascending:!0})),l.append(e("<option>",{html:"&#8615; "+f[b].label,value:b}).data("sort",{type:f[b].type,label:f[b].label,asc:!1}));l.on("change."+u,Te)}m&&m.length&&!m.is(":empty")||g&&g.length&&!g.is(":empty")||p.hide()}else t&&e("#filters").hide()},Je=function(a,s){clearTimeout(a.data("fade")),O().trigger("stopAutoHide");var n=c.find("[data-rel="+a[0].id+"]"),l=function(){a.one("transitionend",function(){a.data("finished")||(a.css({display:"flex",opacity:1}),a.data("finished",!0),window.requestAnimationFrame(r))}).css({transition:"all 500ms ease-out",opacity:1,transform:"translateY(0)"})},r=function(){var t=n.data("autoclose");t&&(a.add(n).on("mouseenter."+u+" mouseover."+u,function(){a.data("over",!0),clearTimeout(a.data("fade"))}).on("mouseleave."+u,function(){a.data("over",!1),a.data("fade",setTimeout(function(){a.data("over")||(clearTimeout(a.data("fade")),ke(a))},t))}),a.data("fade",setTimeout(ke,t,a))),"map"===a[0].id&&(V().data("rendered")?V().trigger("refresh"):setTimeout(function(e){V().trigger("render")},20,e(this))),typeof s===FUNCTION&&s.call(null)};n.is(":visible")?(n.add(a).addClass("on"),clearTimeout(a.data("fade")),window.requestAnimationFrame(function(){var e=n.position(),s=e.top+n.outerHeight(),r=Math.minMax(0,e.left,t.outerWidth()-a.outerWidth());n.trigger("removeTooltip"),a.css({transition:"none",display:"flex",opacity:0,transform:"translateY(16px)"}),a.css({left:r,top:s,maxWidth:"calc(100vw - "+r+"px)",maxHeight:"calc(100vh - "+s+"px)"}),a.data("finished",!1),window.requestAnimationFrame(l)})):ke(a)},ke=function(t,a){if(t.is(":hidden"))t.data("over",!1);else{t.data("over")&&(clearTimeout(t.data("fade")),t.data("fade",setTimeout(ke,1e3,t)));var s=!1;c.find("[data-rel="+t[0].id+"]").add(t).removeClass("on"),t.hideAllTooltips(),t.one("transitionend",function(t){s||(s=!0,e(this).css({transition:"none",display:"none",opacity:0}),e(this).removeClass("on"),typeof a===FUNCTION&&a.call(null))}).css({transition:"all 500ms ease-out",opacity:0,transform:"translateY(16px)"})}},Ie=function(t){o.children(".on").each(function(){ke(e(this))}),typeof t===FUNCTION&&t.call(null)},Re=function(){if(a.hasOwnProperty("share"))if(_().is(":visible")){var t=K();t&&e(a.share.hook).trigger("updateLinks",{sites:a.share,title:t[J.TITLE]||t[J.NAME].stripExt().replace(/[-_]/g," ").capitalize(),description:t[J.COMMENT]||"",image:n.getOptimalImagePath(t,[1200,800]),href:n.getAbsolutePath(t)})}else e(a.share.hook).trigger("updateLinks")},De=function(e,t){var a;(a=function(e){for(var t,a=[],s=0;s<e.length;s++)(t=n.getLocation(e[s]))&&a.push({title:[s+1+".",e[s].title,e[s].comment].filter(Boolean).join(" "),pos:t,link:e[s].path});return a}(e)).length&&V().addMap({apiKey:t.apiKey,type:t.type||"hybrid",zoom:t.zoom||15,markers:a,autoLoad:!0,fullscreenControl:!0,onMarkerClick:function(){if(this.hasOwnProperty("link")){var e=G(this.link);e.length&&(isFullscreen()&&exitFullscreen(),_().is(":visible")||O().trigger("setactivecard",e),z(e))}}})},Me=function(){a.hasOwnProperty("tagCloud")&&"current"!==a.tagCloud.depth&&n.collectTags(e.extend(a.tagCloud,{exact:a.exactFields,ready:function(){ue(this)}}))},Se=function(){if(n){var t,s,l=n.getFolders(),r=a.markNew.days*ONEDAY_S;q(":not(.webloc)").each(function(n){n<l.length&&(s=l[n][J.DATES])&&(s=s[a.markNew.reference]||s[J.DATERANGE][1]||s[J.DATERANGE][0])&&m-s<r&&(t=a.markNew.text?e("<span>",{class:"new-image",text:a.markNew.text}):e("<span>",{class:"icon-new-fill new-image"}),TOUCHENABLED||t.data("tooltip",new Date(1e3*s).toLocaleDateString(LOCALE)).addTooltip(),e(this).find("."+a.thumbClass).eq(0).append(t))})}},Fe=function(){if(!b&&!_().is(":visible")){y&&(clearTimeout(y),y=null);var s=t.scrollTop();if(Math.abs(s-v)>20)return v=s,void(y=setTimeout(Fe,a.scrollCheckInterval));b=!0;var n=q().filter("."+a.lazyloadClass),l=t.height();n.each(function(){var t=e(this),s=t.offset().top;if(s+t.height()>v-l){if(!(s<v+1*l))return!1;t.find("[data-src]").each(function(){var t=e(this),s=t.find("img");s.length||(s=e("<img>",{class:a.disappearClass}).appendTo(t)),s.one("load",function(){e(this).addClass(a.appearClass).removeClass(a.disappearClass)}).attr("src",t.data("src"))}),t.removeClass(a.lazyloadClass)}}),v=s,y=setTimeout(Fe,a.scrollCheckInterval),b=!1}},Ue=function(){var t=q();t.length&&(a.hasOwnProperty("markNew")&&setTimeout(Se,300),setTimeout(function(){Fe(),t.filter("."+a.preloadClass+":first-child img").one("load",function(){e(this).parents("."+a.preloadClass).removeClass(a.preloadClass)}),(!LOCAL||DEBUG)&&a.hasOwnProperty("weblocationCounts")&&a.weblocationCounts&&t.filter(".webloc.has-count").each(function(){var t=e(this).children(".caption");loadExternal(e(this).children(".thumb").attr("href"),function(){if(typeof this===OBJECT&&this.hasOwnProperty(J.DEEPCOUNTERS)){var e="";this[J.DEEPCOUNTERS].images&&(e+="<span>"+this[J.DEEPCOUNTERS].images+"&nbsp;"+translate(this[J.DEEPCOUNTERS].images>1?"images":"image")+"</span>"),this[J.DEEPCOUNTERS].audios&&(e+="<span>"+this[J.DEEPCOUNTERS].audios+"&nbsp;"+translate(this[J.DEEPCOUNTERS].audios>1?"audios":"audio")+"</span>"),this[J.DEEPCOUNTERS].videos&&(e+="<span>"+this[J.DEEPCOUNTERS].videos+"&nbsp;"+translate(this[J.DEEPCOUNTERS].videos>1?"videos":"video")+"</span>"),this[J.DEEPCOUNTERS].others&&(e+="<span>"+this[J.DEEPCOUNTERS].others+"&nbsp;"+translate(this[J.DEEPCOUNTERS].others>1?"others":"other")+"</span>"),e&&t.find(".counts").empty().append(e)}})})},500))};return window.location.search&&removeSearch(),restoreScrollPosition(),e(window).on("beforeunload."+u,saveScrollPosition),loadPrefs(a,["audioClipVolume"],"lb_pref"),passDefaults(a,e.fn.lightbox.defaults,"indexName,level,previousFoldersLast,previousFolderPath,nextFoldersFirst,nextFolderPath,extraSizes,hiDpiThumbs,hiDpiImages,audioClipVolume,lightboxFullscreen,slideshowFullscreen,rightClickProtect,enableKeyboard,enableMouseWheel,fotomoto,useRating,visitorRating"),passDefaults(a.lightbox,e.fn.lightbox.defaults),function(t){typeof Album===UNDEF&&console.log("Critical Error: Missing jalbum.album.js library!");var s=a.hasOwnProperty("tagCloud")&&"current"!==a.tagCloud.depth||"page"===a.pageType&&"newimages"===a.pageName,l={makeDate:a.makeDate,rootPath:a.rootPath,relPath:a.relPath,hiDpiImages:a.hiDpiImages||!1,hiDpiThumbs:a.hiDpiThumbs||!1,thumbDims:a.thumbDims||[389,259],ready:"index"===a.pageType?function(){if(n){var t=n.getImages();F().each(function(){var t=e(this).find("."+a.imageClass);t.data("href",t.attr("href")),t.attr("href","")}),Ue(),e.fn.hasOwnProperty("paypal")&&n.hasShop()&&(d=e("#shop-root"),e.fn.paypal.defaults.relPath=a.relPath,e.fn.paypal.defaults.rootPath=a.rootPath,C=n.getCurrency(),e.fn.hasOwnProperty("rangeSlider")&&(e.fn.rangeSlider.defaults.currency=C),d.length&&(d.paypal(n,{getSelected:j,selectNone:function(){N().trigger("selectNone")},getCurrent:K,button:c.find("[data-rel=shop]")}),d.find("."+a.addSelectedClass).on("click",function(){return d.trigger("addItems",j()),N().trigger("selectNone"),!1}),e.fn.lightbox.defaults.hasOwnProperty("shop")||(e.fn.lightbox.defaults.shop={}),e.fn.lightbox.defaults.shop.root=d)),a.hasOwnProperty("feedback")&&(h=e("#feedback-root"),e.fn.feedback.defaults.relPath=a.relPath,e.fn.feedback.defaults.rootPath=a.rootPath,h.length&&(a.feedback.getSelected=function(){return j()},a.feedback.selectNone=function(){N().trigger("selectNone")},a.feedback.getCurrent=function(){return K()},a.feedback.button=c.find("[data-rel=feedback]"),h.feedback(n,a.feedback),h.find("."+a.addSelectedClass).on("click",function(){return h.trigger("addItems",j()),N().trigger("selectNone"),!1}),e.fn.lightbox.defaults.hasOwnProperty("feedback")||(e.fn.lightbox.defaults.feedback={}),e.fn.lightbox.defaults.feedback.root=h)),d.add(h).find("."+a.selectAllClass).on("click",function(){return O().trigger("selectAll"),!1}),d.add(h).find("."+a.selectNoneClass).on("click",function(){return O().trigger("selectNone"),!1}),t.length?(N().renderImages(t,le,!0),e(a.startSlideshowHook).on("click",ie)):(window.location.hash&&re(),e(a.startSlideshowHook).hide()),a.hasOwnProperty("tagCloud")&&"current"===a.tagCloud.depth&&n.collectTags(e.extend(a.tagCloud,{exact:a.exactFields,ready:function(){ue(this)}})),a.hasOwnProperty("search")&&de(e(a.search.hook)),a.hasOwnProperty("searchNew")&&function(t){if(t.length&&n){a.searchNew=e.extend({days:"3,30,90",depth:"folder",reference:"dateTaken",sinceLastVisit:!0},a.searchNew);var s=a.searchNew.days.split(",");t.append(e("<label>",{text:ge(a.searchNew.reference)})),t=e("<div>",{class:"buttons"}).appendTo(t);for(var l=0;l<s.length;l++)t.append(e("<a>",{class:"small button",text:getTimespan(s[l])}).data("days",parseInt(s[l],10)).on("click",function(){ve(e(this).data("days"))}));if(a.searchNew.sinceLastVisit){var r=e.cookie("lastVisit"),o=Math.round(new Date/1e3);r&&r<o-ONEDAY_S&&t.append(e("<a>",{class:"small button",text:i.sinceMyLastVisit}).on("click",function(){ve((o-r)/ONEDAY_S)})),e.cookie("lastVisit",o,31536e4)}}}(e(a.searchNew.hook));var s=e("[data-jalbum-query]");if(s.length){var l=s.data("jalbum-query");l.hasOwnProperty("fn")&&n[l.fn](e.extend(l,{ready:function(t){for(var r,i=0,o=Math.min(this.length,10);i<o;i++)r=this[i],e("<a>",{href:n.getLink(r)}).appendTo(s).append(e("<img>",{src:n.getThumbPath(r),width:r[J.THUMB][J.WIDTH],height:r[J.THUMB][J.HEIGHT],alt:r[J.TITLE]||r[J.NAME]}));this.length>10&&s.append(e("<a>",{class:"more",href:l.linkMore,text:"+"+(this.length-10)})),a.rightClickProtect&&s.on("contextmenu","img",function(e){return e.preventDefault(),!1})}}))}}}:function(){a.hasOwnProperty("search")&&de(e(a.search.hook)),a.pageName=window.location.pathname.getFile();var t=[];S().each(function(){var s=e(this).find("."+a.imageClass);s.data("href",s.attr("href")),s.attr("href",""),t.push(e(this).data(J.PATH))}),t.length&&(function(e,t){var t=typeof t===UNDEF?O():t,e=typeof e===UNDEF?t.hasClass(a.baseOverlayClass)?"base":w():e;t.attr("data-overlay",e)}(),n.collectByPath({paths:t,ready:function(){this.length&&(N().renderImages(this,le,!0),a.hasOwnProperty("map")&&De(this,a.map))}}))},loadDeep:s};a.indexName!==e.fn.skin.defaults.indexName&&(l.indexName=a.indexName),a.audioPoster!==e.fn.skin.defaults.audioPoster&&(l.audioPoster=a.audioPoster),a.videoPoster!==e.fn.skin.defaults.videoPoster&&(l.videoPoster=a.videoPoster),s&&(l.deepReady=Me),n=new Album(e,l)}(),a.rightClickProtect&&F().add(q()).on("contextmenu","img",function(e){return e.preventDefault(),!1}),c.find(".fullscreen").length&&(c.find(".fullscreen").on("click."+u,function(){e(this).trigger("removeTooltip"),requestFullscreen(function(){l.addClass(a.fullscreenClass)})}),c.find(".windowed").on("click."+u,function(){e(this).trigger("removeTooltip"),exitFullscreen(function(){l.removeClass(a.fullscreenClass)})})),o.find("#topnav .collapsible .has-submenu").each(function(){var t=e(this);e("<span>",{class:"collbtn icon-caret-down"}).appendTo(t).on("click",function(t){t.preventDefault();var a=e(this);return a.parent().hasClass("collapsed")?a.parent().removeClass("collapsed"):a.parent().addClass("collapsed"),!1}),t.hasClass("actual")||t.find(".actual").length||t.addClass("collapsed")}),o.find(".zip-cont a.button").each(function(){var t=e(this);getFileSize(t.attr("href"),function(e){e&&t.append('<span class="badge">'+niceByte(e)+"</span>")})}),l.on("click."+u,function(t){return e(t.target).closest("."+a.panelClass).length||Ie(),!0}),t.on("scroll."+u,function(){o.toggleClass(a.abovefoldClass,t.scrollTop()>2),a.autoplayVideoInView&&!_().is(":visible")&&se()}),c.find("[data-rel]").each(function(){var t=e(this);e("#"+t.data("rel")).length?t.addClass("has-panel").on("selectstart."+u,function(e){return e.preventDefault(),!1}).on("click."+u,function(){var t=e(this).closest("."+a.controlsClass),s=e(this),n=e("#"+s.data("rel"));return t.hideAllTooltips(),n.data("over",!1),s.hasClass("on")?ke(n):Ie(function(){n.data("over",!0),Je(n)}),!1}):t.removeAttr("data-rel")}),a.hasOwnProperty("share")&&function(t){e.fn.renderShares.defaults.buttonTheme=t.buttonTheme||"dark",e.fn.renderShares.defaults.indexName=a.indexName,e.fn.renderShares.defaults.facebookAppId=t.facebookAppId||"",t.hasOwnProperty("callAction")&&(e.fn.renderShares.defaults.callAction=t.callAction),e(t.hook).renderShares(t),t.hasOwnProperty("sites")&&(e.fn.lightbox.defaults.share=t.sites,e.fn.lightbox.defaults.shareHook=t.hook)}(a.share),function(e){e.length&&e.audioPlayer({rootPath:a.rootPath})}(e("[data-audioPlayer]")),t.on("hashchange."+u,re),l.on("overlayReady."+u,function(e,t){moveInView(t)}),this.getAlbum=function(){return n},this},e.fn.skin.defaults={contentClass:"content",contClass:"cont",startSlideshowHook:"#start-slideshow",hasOverlayClass:"has-overlay",baseOverlayClass:"base-overlay",hideOnOverlayClass:"hide-on-overlay",overlayClass:"overlay",overlayTitleClass:"title",overlayHeadLevel:3,progressbarClass:"progressbar",lightboxClass:"lightbox",controlsClass:"controls",panelClass:"panel",panelsClass:"panels",sliderClass:"slider",belowfoldClass:"below-fold",abovefoldClass:"above-fold",folderContClass:"folder-cont",foldersClass:"folders",folderClass:"folder",thumbnailsClass:"thumbnails",thumbContClass:"thumb-cont",thumbClass:"thumb",tagCloudClass:"tag-cloud",tagSearchClass:"tag-search",thumbLayout:"fixgrid",columns:4,imageClass:"image",captionClasses:"over bottom hover",cardClass:"card",appearClass:"appear",disappearClass:"disappear",disabledClass:"disabled",folderCardClass:"foldercard",mosaicClass:"mosaic",captionPlacement:"below",lbableClass:"lbable",captionClass:"caption",commentClass:"comment",hascaptionClass:"hascaption",selectableClass:"selectable",selectedClass:"checked",activeClass:"active",preloadClass:"preload",lazyloadClass:"lazyload",hideImageClass:"hide-image",showImageClass:"show-image",startshowClass:"start-btn",fullscreenClass:"fullscreen",panoClass:"pano",selectBoxClass:"select-box",selectAllClass:"select-all",selectNoneClass:"select-none",keepSelectedClass:"keep-selected",addSelectedClass:"add-selected",scrollCheckInterval:250,indexName:"index.html",audioPoster:"audio.poster.png",videoPoster:"video.poster.png",exactFields:"creator,keywords",hidePanelDelay:{topnav:6e3,map:1e4,albuminfo:1e4,player:3e3,social:6e3,filters:15e3,search:0,tagcloud:6e3},dateFormat:"M/d/yyyy",thumbDims:[389,259],thumbGap:4,audioClipVolume:.75,autoplayVideoInView:!0,lightboxFullscreen:!1,slideshowFullscreen:!1,slideshowFullscreenOnlyMobiles:!0,rightClickProtect:!1,useRating:!1,jalbumRating:!1,visitorRating:!1,enableKeyboard:!0,videoAuto:!0,linkToFolder:!0,scrollToTopButton:!0}}(jQuery,jQuery(window),jQuery(document),jQuery("body"));
